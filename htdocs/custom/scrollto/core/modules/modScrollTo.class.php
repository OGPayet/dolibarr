...
class modScrollTo extends DolibarrModules
{
	...
	function __construct($db)
	{
		...
		// for specific css file (eg: /scrollto/css/scrollto.css.php)
        ...
        /* Example:
        if (! isset($conf->scrollto->enabled)) $conf->scrollto->enabled=0;	// This is to avoid warnings
        $this->dictionaries=array(
            ...
            'tabcond'=>array($conf->scrollto->enabled,$conf->scrollto->enabled,$conf->scrollto->enabled)												// Condition to show each dictionary
        );
        */
		...
		//							'titre'=>'ScrollTo top menu',
		//							'mainmenu'=>'scrollto',
		//							'leftmenu'=>'scrollto',
		//							'url'=>'/scrollto/pagetop.php',
		//							'langs'=>'mylangfile@scrollto',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
		//							'position'=>100,
		//							'enabled'=>'$conf->scrollto->enabled',	// Define condition to show or hide menu entry. Use '$conf->scrollto->enabled' if entry must be visible if module is enabled.
		//							'perms'=>'1',			                // Use 'perms'=>'$user->rights->scrollto->level1->level2' if you want your menu with a permission rules
		//							'target'=>'',
		...
		//							'titre'=>'ScrollTo left menu',
		//							'mainmenu'=>'xxx',
		//							'leftmenu'=>'scrollto',
		//							'url'=>'/scrollto/pagelevel2.php',
		//							'langs'=>'mylangfile@scrollto',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
		//							'position'=>100,
		//							'enabled'=>'$conf->scrollto->enabled',  // Define condition to show or hide menu entry. Use '$conf->scrollto->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
		//							'perms'=>'1',			                // Use 'perms'=>'$user->rights->scrollto->level1->level2' if you want your menu with a permission rules
		//							'target'=>'',
		//							'user'=>2);				                // 0=Menu for internal users, 1=external users, 2=both
		// $r++;
