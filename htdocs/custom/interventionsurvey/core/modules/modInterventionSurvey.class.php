...
class modInterventionSurvey extends DolibarrModules
{
    ...
    public function init($options = '')
    {
        ...
        $extrafields->addExtraField('scheduled_stakeholder', $langs->trans('InterventionSurveyScheduledUserLabel'), 'chkbxlst', 10,  NULL, 'fichinter',   0, 1, NULL, array('options'=>array('user:firstname|lastname:rowid::statut = 1 AND fk_soc IS NULL'=>null)), 1, '', 1, 0, '', '', 'interventionsurvey@interventionsurvey', '$conf->interventionsurvey->enabled');
