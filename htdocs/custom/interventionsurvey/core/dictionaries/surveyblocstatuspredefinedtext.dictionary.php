...
/**
 * \file        core/dictionaries/surveyblocstatuspredefinedtext.dictionary.php
...
/**
 * Class for SurveyBlocStatusPredefinedTextDictionary
 */
class SurveyBlocStatusPredefinedTextDictionary extends Dictionary
{
    /**
     ...
     */
    public $nameLabel = 'InterventionSurveyBlocStatusPredefinedTextDictionaryName';

    /**
     * @var string      Name of the dictionary table without prefix (ex: c_country)
     */
    public $table_name = 'c_intervention_survey_bloc_status_predefined_text';
    ...
    public $fields = array(
        'position' => array(
            'name'       => 'position',
            'label'      => 'InterventionSurveyBlocStatusPredefinedTextOrderFieldLabel',
            'type'       => 'int',
            'database'   => array(
                'length'   => 10,
            ),
        ...
        'identifier' => array(
            'name'       => 'identifier',
            'label'      => 'InterventionSurveyBlocStatusPredefinedTextIdentifierFieldLabel',
            'type'       => 'varchar',
            'database'   => array(
                'length'   => 255,
            ),
            'is_require' => false,
            'help'       => 'InterventionSurveyBlocStatusPredefinedTextIdentifierFieldHelp'
        ),
        'label' => array(
            'name'       => 'label',
    ...
    protected function initialize()
    {
        $this->fields['status'] = array(
            'name' => 'answers',
            'label' => 'InterventionSurveyStatusPredefinedTextUsedInTheseBlocStatusDictionaryField',
            'type' => 'chkbxlst',
...
class SurveyBlocStatusPredefinedTextDictionaryLine extends DictionaryLine
{
