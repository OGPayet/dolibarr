...
class SurveyBlocStatusDictionary extends Dictionary
{
     ...
     */
    public $nameLabel = 'InterventionSurveyBlocStatusDictionaryName';

    /**
     * @var string      Name of the dictionary table without prefix (ex: c_country)
     */
    public $table_name = 'c_intervention_survey_bloc_status';
    ...
    public $fields = array(
        'position' => array(
            'name'       => 'position',
            'label'      => 'InterventionSurveyBlocStatusOrderDictionaryFieldLabel',
            'type'       => 'int',
            'database'   => array(
              'length'   => 10,
            ),
        ...
        'identifier' => array(
            'name'       => 'identifier',
            'label'      => 'InterventionSurveyBlocStatusIdentifierFieldLabel',
            'type'       => 'varchar',
            'database'   => array(
              'length'   => 255,
            ),
            'is_require' => false,
            'help'       => 'InterventionSurveyBlocStatusIdentifierFieldHelp'
        ),
        'label' => array(
            'name'       => 'label',
            'label'      => 'InterventionSurveyBlocStatusLabelDictionaryFieldLabel',
            'type'       => 'varchar',
            'database'   => array(
              'length'   => 255,
            ),
        ...
        'color' => array(
            'name'       => 'color',
            'label'      => 'InterventionSurveyBlocStatusColorDictionaryFieldLabel',
            'help'       => 'InterventionSurveyBlocStatusColorDictionaryFieldHelp',
            'type'       => 'varchar',
            'database'   => array(
                'length' => 10,
            ),
        ...
        'mandatory_justification' => array(
            ...
            'label'      => 'InterventionSurveyBlocStatusMandatoryJustificationDictionaryFieldLabel',
            'type'       => 'boolean',
        ),
        'deactivate_bloc' => array(
            'name'       => 'deactivate_bloc',
	...
	protected function initialize()
    {
        $this->fields['predefined_texts'] = array(
            ...
            'label' => 'InterventionSurveyBlocStatusPredefinedTextDictionaryLabel',
            'type' => 'chkbxlst',
            'options' => 'c_intervention_survey_bloc_status_predefined_text:identifier|label:rowid::active=1 and entity IN (' . getEntity('dictionary', 1) . ')',
            'label_separator' => ' - ',
            'td_input' => array(
        ...
        $this->fields['bloc_questions'] = array(
            'name' => 'bloc_questions',
            'label' => 'InterventionSurveyStatusIsUsedInTheseBlocQuestionDictionary',
            'type' => 'chkbxlst',
            'options' => 'c_intervention_survey_bloc_question:identifier|label:rowid::active=1 and entity IN (' . getEntity('dictionary', 1) . ')',
            'association_table' => 'c_intervention_survey_bloc_question_cbl_status:fk_target:fk_line',
            'label_separator' => ' - ',
            'td_input' => array(
                'moreAttributes' => 'width="100%"',
                'positionLine' => 2,
