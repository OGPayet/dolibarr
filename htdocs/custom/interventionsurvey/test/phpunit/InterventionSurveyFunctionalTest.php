...
/**
 * \file    test/functional/InterventionSurveyFunctionalTest.php
...
/**
 * Class InterventionSurveyFunctionalTest
 *
 ...
 *
 * @package Testinterventionsurvey
 */
class InterventionSurveyFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modInterventionSurvey')->click();
		} else {
			// Disable the module
			$this->byHref('modInterventionSurvey')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/interventionsurvey/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('interventionsurvey/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/interventionsurvey/admin/about.php');
		$this->authenticate();
		return $this->assertContains('interventionsurvey/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('interventionsurveywidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
        ...
        return $this->assertContains(
			'interface_99_modInterventionSurvey_InterventionSurveyTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
        ...
        return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modInterventionSurvey_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
