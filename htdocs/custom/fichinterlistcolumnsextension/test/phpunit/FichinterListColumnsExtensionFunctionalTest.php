...
/**
 * \file    test/phpunit/FichinterListColumnsExtensionFunctionalTest.php
...
/**
 * Class FichinterListColumnsExtensionFunctionalTest
 *
 ...
 *
 * @package Testfichinterlistcolumnsextension
 */
class FichinterListColumnsExtensionFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modFichinterListColumnsExtension')->click();
		} else {
			// Disable the module
			$this->byHref('modFichinterListColumnsExtension')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/fichinterlistcolumnsextension/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('fichinterlistcolumnsextension/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/fichinterlistcolumnsextension/admin/about.php');
		$this->authenticate();
		return $this->assertContains('fichinterlistcolumnsextension/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('fichinterlistcolumnsextensionwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modFichinterListColumnsExtension_FichinterListColumnsExtensionTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modFichinterListColumnsExtension_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
