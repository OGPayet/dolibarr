...
/**
 * \file    test/phpunit/ContractListColumnsExtensionFunctionalTest.php
...
/**
 * Class ContractListColumnsExtensionFunctionalTest
 *
 ...
 *
 * @package Testcontractlistcolumnsextension
 */
class ContractListColumnsExtensionFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modContractListColumnsExtension')->click();
		} else {
			// Disable the module
			$this->byHref('modContractListColumnsExtension')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/contractlistcolumnsextension/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('contractlistcolumnsextension/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/contractlistcolumnsextension/admin/about.php');
		$this->authenticate();
		return $this->assertContains('contractlistcolumnsextension/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('contractlistcolumnsextensionwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modContractListColumnsExtension_ContractListColumnsExtensionTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modContractListColumnsExtension_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
