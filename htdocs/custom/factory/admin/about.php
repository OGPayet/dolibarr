...
print '<input style="cursor:pointer; font-family: Happy Monkey; background-color: #ff6600; font-variant: small-caps; font-size: 14px; font-weight: bold; height: 30px; width: 150px;" name="readmore" type="button" value="'.$langs->trans("LienModules").'" /></a>';
print' </td>';
...
print '<td width="20%"><a href="http://patas-monkey.com/index.php/fr/services" target="_blank"> <input style="cursor:pointer; font-family: Happy Monkey; background-color: #ff6600; font-variant: small-caps; font-size: 14px; font-weight: bold; height: 30px; width: 150px;" name="readmore" type="button" value="'.$langs->trans("LienServices").'" /></a>';
print' </td>';
print '</tr>';
print '<tr align="center">';
print '<td align="center" ><a href="http://docs.patas-monkey.com/documentation" target="_blank"> <input style="cursor:pointer; font-family: Happy Monkey; background-color: #ff6600; font-variant: small-caps; font-size: 14px; font-weight: bold; width: 150px; height: 30px;" name="readmore" type="button" value="'.$langs->trans("LienDoc").'" /></a>';
print' </td>';
print '</tr>';
print '</tbody>';
print '</table>';
...
$changelog = @file_get_contents(
				str_replace("www", "dlbdemo", $urlmonkey).'/htdocs/custom/factory/changelog.xml',
				false, $context
);
