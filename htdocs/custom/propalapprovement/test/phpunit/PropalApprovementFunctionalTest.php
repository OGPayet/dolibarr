...
/**
 * \file    test/phpunit/PropalApprovementFunctionalTest.php
...
/**
 * Class PropalApprovementFunctionalTest
 *
 ...
 *
 * @package Testpropalapprovement
 */
class PropalApprovementFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modPropalApprovement')->click();
		} else {
			// Disable the module
			$this->byHref('modPropalApprovement')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/propalapprovement/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('propalapprovement/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/propalapprovement/admin/about.php');
		$this->authenticate();
		return $this->assertContains('propalapprovement/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('propalapprovementwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modPropalApprovement_PropalApprovementTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modPropalApprovement_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
