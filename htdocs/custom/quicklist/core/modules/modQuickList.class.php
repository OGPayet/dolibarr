...
/**
 * 	\defgroup   quicklist     Module QuickList
 *  \brief      Example of a module descriptor.
 *				Such a file must be copied into htdocs/quicklist/core/modules directory.
 *  \file       htdocs/quicklist/core/modules/modQuickList.class.php
 *  \ingroup    quicklist
 *  \brief      Description and activation file for module QuickList
 */
include_once DOL_DOCUMENT_ROOT . '/core/modules/DolibarrModules.class.php';


/**
 *  Description and activation class for module QuickList
 */
class modQuickList extends DolibarrModules
{
    var $extrafields;
	...
	public function __construct($db)
	{
		...
		$this->numero = 163011;		// TODO Go on page http://wiki.dolibarr.org/index.php/List_of_modules_id to reserve id number for your module
		...
		//                        );
		$this->module_parts = array(
            'css' => array('/quicklist/css/quicklist.css.php'),
            'js' => array('/quicklist/js/quicklist.js.php'),
            'hooks' => array('main'),
        );
		...
		$this->config_page_url = array("setup.php@quicklist");
		...
		$this->langfiles = array("quicklist@quicklist", "opendsi@quicklist");
	...
	public function init($options='')
	{
		...
		$this->_load_tables('/quicklist/sql/');
