...
/**
 * \file    modulebuilder/template/core/boxes/synergiestechcontratwidget1.php
 * \ingroup synergiestechcontrat
 * \brief   Widget provided by synergiestechcontrat
 *
 ...
 */
class synergiestechcontratwidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "synergiestechcontratbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "synergiestechcontrat@synergiestechcontrat";
	 ...
	 */
	public $depends = array('synergiestechcontrat');
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		//$this->hidden = ! ($user->rights->synergiestechcontrat->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		//include_once DOL_DOCUMENT_ROOT . "/synergiestechcontrat/class/synergiestechcontrat.class.php";

		// Populate the head at runtime
		$text = $langs->trans("synergiestechcontratBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_synergiestechcontrat@synergiestechcontrat',
