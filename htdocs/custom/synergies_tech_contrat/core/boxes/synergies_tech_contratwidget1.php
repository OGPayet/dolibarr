...
/**
 * \file    modulebuilder/template/core/boxes/synergies_tech_contratwidget1.php
 * \ingroup synergies_tech_contrat
 * \brief   Widget provided by synergies_tech_contrat
 *
 ...
 */
class synergies_tech_contratwidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "synergies_tech_contratbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "synergies_tech_contrat@synergies_tech_contrat";
	 ...
	 */
	public $depends = array('synergies_tech_contrat');
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		//$this->hidden = ! ($user->rights->synergies_tech_contrat->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		//include_once DOL_DOCUMENT_ROOT . "/synergies_tech_contrat/class/synergies_tech_contrat.class.php";

		// Populate the head at runtime
		$text = $langs->trans("synergies_tech_contratBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_synergies_tech_contrat@synergies_tech_contrat',
