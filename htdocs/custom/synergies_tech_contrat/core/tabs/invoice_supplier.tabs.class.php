...
Class TabsInvoice_supplier
	...
	*/
	public function _Init(){
		...
		$class = (string)$this->FV->GetClassByType($this->type);
		// load Specific context

		$this->object = new $class($this->db);


// 		$r = $this->FV->GetClassByType('propal');
	...
	*/
	public function _Process(){
		...
		if($this->GetParams('facid') != null || $this->GetParams('ref') != null) {

			$this->object->fetch($this->GetParams('facid'), $this->GetParams('ref'));
