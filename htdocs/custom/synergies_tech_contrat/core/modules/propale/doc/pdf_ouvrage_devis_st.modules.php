 ...
 */
class pdf_ouvrage_devis_st extends ModelePDFPropales
{
    use libPDFST;
	var $db;
	var $name;
	...
	var	$marge_haute;
	var	$marge_basse;
    var $main_color = array(235, 115, 15);
			...
			if (file_exists($dir))
			{
				...
				for ($i = 0; $i < $nblignes; $i++)
				{
					...
					if (isset($imglinesize['width']) && isset($imglinesize['height']))
					{
						...
						$pdf->Image($realpatharray[$i], $curX + (($this->posxtva-$this->posxpicture-$imglinesize['width'])/2) - 5, $curY, $imglinesize['width'], $imglinesize['height'], '', '', '', 2, 300);	// Use 300 dpi
						// $pdf->Image does not increase value return by getY, so we save it manually
						$posYAfterImage=$curY+$imglinesize['height'];
					}

					// Description of product line
					$curX = $this->posxdesc-6;
