...
/**
 *  \file       sepamandat_note.php
 *  \ingroup    sepamandatmanager
 *  \brief      Car with notes on Sepamandat
 */
...
if ($id > 0 || !empty($ref)) $upload_dir = $object->getAbsolutePath();
...
$help_url = '';
llxHeader('', $langs->trans('Sepamandat'), $help_url);
...
if ($id > 0 || !empty($ref))
{
	...
	dol_fiche_head($head, 'note', $langs->trans("Sepamandat"), -1, $object->picto);
