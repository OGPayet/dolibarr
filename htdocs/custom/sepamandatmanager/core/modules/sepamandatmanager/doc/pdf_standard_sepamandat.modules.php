 ...
 */
class pdf_standard_sepamandat extends ModelePDFSepamandat
{
    /**
	...
	*/
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
	    ...
	    /*
	    if (!empty($conf->global->MAIN_GENERATE_SEPAMANDAT_WITH_PICTURE))
	    {
		...
		*/
	    ...
	    if ($conf->sepamandatmanager->dir_output.'/sepamandat')
	    {
	        ...
	        if ($object->specimen)
	        {
			$dir = $conf->sepamandatmanager->dir_output.'/sepamandat';
	            $file = $dir."/SPECIMEN.pdf";
	        } else {
	            $objectref = dol_sanitizeFileName($object->ref);
	            $dir = $conf->sepamandatmanager->dir_output.'/sepamandat/'.$objectref;
