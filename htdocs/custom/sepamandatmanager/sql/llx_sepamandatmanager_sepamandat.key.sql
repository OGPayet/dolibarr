...
ALTER TABLE llx_sepamandatmanager_sepamandat ADD INDEX idx_sepamandatmanager_sepamandat_rowid (rowid);
ALTER TABLE llx_sepamandatmanager_sepamandat ADD INDEX idx_sepamandatmanager_sepamandat_ref (ref);
ALTER TABLE llx_sepamandatmanager_sepamandat ADD INDEX idx_sepamandatmanager_sepamandat_fk_soc (fk_soc);
...
--ALTER TABLE llx_sepamandatmanager_sepamandat ADD CONSTRAINT llx_sepamandatmanager_sepamandat_fk_field FOREIGN KEY (fk_field) REFERENCES llx_sepamandatmanager_myotherobject(rowid);
