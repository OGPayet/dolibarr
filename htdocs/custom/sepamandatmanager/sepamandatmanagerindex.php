...
/**
 *	\file       sepamandatmanager/sepamandatmanagerindex.php
 *	\ingroup    sepamandatmanager
 *	\brief      Home page of sepamandatmanager top menu
 */
...
$langs->loadLangs(array("sepamandatmanager@sepamandatmanager"));

$action = GETPOST('action', 'alpha');


// Security check
//if (! $user->rights->sepamandatmanager->myobject->read) accessforbidden();
...
llxHeader("", $langs->trans("SepaMandatManagerArea"));

print load_fiche_titre($langs->trans("SepaMandatManagerArea"), '', 'sepamandatmanager.png@sepamandatmanager');
...
// Draft MyObject
if (! empty($conf->sepamandatmanager->enabled) && $user->rights->sepamandatmanager->read)
{
	$langs->load("orders");
