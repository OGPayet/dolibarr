...
/**
 *  \file       sepamandat_document.php
 *  \ingroup    sepamandatmanager
 *  \brief      Tab for documents linked to Sepamandat
 */
...
$hookmanager->initHooks(array('sepamandatdocument', 'globalcard')); // Note that conf->hooks_modules contains array
...
$title = $langs->trans("Sepamandat").' - '.$langs->trans("Files");
$help_url = '';
...
if ($object->id)
{
	...
	dol_fiche_head($head, 'document', $langs->trans("Sepamandat"), -1, $object->picto);
