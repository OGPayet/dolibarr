...
/**
 *	    \file       htdocs/extendedemail/admin/about.php
 *		\ingroup    extendedemail
 *		\brief      Page about of extendedemail module
 */
...
dol_include_once('/extendedemail/lib/opendsi_common.lib.php');
...
dol_fiche_head($head, 'changelog', $langs->trans("Module163006Name"), 0, 'action');

$changelog = opendsi_common_getChangeLog('extendedemail');
