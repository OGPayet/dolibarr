...
/**
 * 	\defgroup   extendedemail     Module ExtendedEmail
 *  \brief      Example of a module descriptor.
 *				Such a file must be copied into htdocs/extendedemail/core/modules directory.
 *  \file       htdocs/extendedemail/core/modules/modExtendedEmail.class.php
 *  \ingroup    extendedemail
 *  \brief      Description and activation file for module ExtendedEmail
 */
include_once DOL_DOCUMENT_ROOT . '/core/modules/DolibarrModules.class.php';


/**
 *  Description and activation class for module ExtendedEmail
 */
class modExtendedEmail extends DolibarrModules
{
    var $extrafields;
	...
	public function __construct($db)
	{
		...
		$this->numero = 163006;		// TODO Go on page http://wiki.dolibarr.org/index.php/List_of_modules_id to reserve id number for your module
        ...
        $this->description = "Description of module Extended Email";
		...
		$this->module_parts = array(
            'substitutions' => 1,
            'css' => array('/extendedemail/css/selectize.default.css', '/extendedemail/css/extendedemail.css'),
            'js' => array('/extendedemail/js/selectize.js', '/extendedemail/js/extendedemail.js.php'),
            'hooks' => array('formmail'),
        );
		...
		$this->config_page_url = array("setup.php@extendedemail");
		...
		$this->langfiles = array("extendedemail@extendedemail", "opendsi@extendedemail");
		...
		// );
		$this->const = array(
            0=>array('EXTENDEDEMAIL_ADD_USER_TO_SENDTO','chaine','0','Permettre la sélection des utilisateurs internes en tant que "Destinataire(s)"',0, 'current', 0),
        ...
        $this->tabs = array(
            'user:+extendedemail_user_generic_email:SUBSTITUTION_EXTENDEDEMAILUSERGENERICEMAILTABLABEL:extendedemail@extendedemail:$user->rights->extendedemail->user_generic_email->read:/extendedemail/user/generic_email_tab.php?id=__ID__',
        );
		...
		if (!(!empty($conf->multicompany->enabled) && $conf->entity == 1 && $user->admin && !$user->entity)) {
            $tabsql .= ' WHERE f.entity='.$conf->entity;
            $tabfieldinsert .= ",entity";
        }
		$this->dictionaries=array(
            'langs'=>'extendedemail@extendedemail',
            'tabname'=>array(MAIN_DB_PREFIX."c_extentedemail_generic_email"),
            'tablib'=>array("ExtendedEmailGenericEmailDictionary"),
            'tabsql'=>array($tabsql),
            'tabsqlsort'=>array("email ASC"),
            'tabfield'=>array("email,name"),
            'tabfieldvalue'=>array("email,name"),
            'tabfieldinsert'=>array($tabfieldinsert),
            'tabrowid'=>array("rowid"),
            'tabcond'=>array($conf->extendedemail->enabled)
        );
        /* Example:
        $this->dictionaries=array(
	...
	public function init($options='')
	{
		...
		$this->_load_tables('/extendedemail/sql/');
