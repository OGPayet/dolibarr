# WAREHOUSECHILD FOR DOLIBARR ERP CRM

## Features
warehousechildDescription
...
- Clone the repository in ```$dolibarr_main_document_root_alt/warehousechild```

```sh
git clone git@github.com:Dolibarr/dolibarr-module-template.git warehousechild
```
