 ...
 */
function addDispatchLineWarehousechild(index, type, mode, unlock_qty)
{
    ...
    if ((unlock_qty===false && qtyDispatched < qtyOrdered) || unlock_qty===true)
    {
        ...
        if (unlock_qty===false) {
            $("#qty_"+(nbrTrs-1)+"_"+index).change(this.onChangeDispatchLineQtyWarehousechild);
        }
...
function onChangeDispatchLineQtyWarehousechild() {
