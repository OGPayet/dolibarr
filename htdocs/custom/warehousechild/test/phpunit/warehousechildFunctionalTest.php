...
/**
 * \file    test/functional/warehousechildFunctionalTest.php
...
/**
 * Class warehousechildFunctionalTest
 *
 ...
 *
 * @package Testwarehousechild
 */
class warehousechildFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
...
//        )
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modwarehousechild')->click();
		} else {
			// Disable the module
			$this->byHref('modwarehousechild')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/warehousechild/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('warehousechild/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/warehousechild/admin/about.php');
		$this->authenticate();
		return $this->assertContains('warehousechild/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('warehousechildwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modwarehousechild_warehousechildTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modwarehousechild_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
