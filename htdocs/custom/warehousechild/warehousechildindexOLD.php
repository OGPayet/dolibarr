...
/**
 *	\file       htdocs/warehousechild/template/warehousechildindex.php
 *	\ingroup    warehousechild
 *	\brief      Home page of warehousechild top menu
 */
...
//if (! $user->rights->warehousechild->read) accessforbidden();
...
llxHeader("",$langs->trans("warehousechildArea"));

print load_fiche_titre($langs->trans("warehousechildArea"),'','warehousechild.png@warehousechild');
...
// Draft MyObject*/
if (! empty($conf->warehousechild->enabled) && $user->rights->warehousechild->read)
{
	$langs->load("orders");
