...
/**
 * \file    modulebuilder/template/core/boxes/warehousechildwidget1.php
 * \ingroup warehousechild
 * \brief   Widget provided by warehousechild
 *
 ...
 */
class warehousechildwidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "warehousechildbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "warehousechild@warehousechild";
	 ...
	 */
	public $depends = array('warehousechild');
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		//$this->hidden = ! ($user->rights->warehousechild->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		//include_once DOL_DOCUMENT_ROOT . "/warehousechild/class/warehousechild.class.php";

		// Populate the head at runtime
		$text = $langs->trans("warehousechildBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_warehousechild@warehousechild',
