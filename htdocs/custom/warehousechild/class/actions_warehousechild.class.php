...
/**
 * \file    class/actions_warehousechild.class.php
...
//header('Location: http://www.exampe.com/');
        ...
        if (in_array($parameters['currentcontext'], array('main'))) {    // do something only for the context 'somecontext1' or 'somecontext2'
