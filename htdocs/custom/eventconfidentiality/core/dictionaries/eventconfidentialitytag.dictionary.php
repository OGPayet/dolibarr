...
/**
 * \file        core/dictionaries/eventconfidentialitytag.dictionary.php
 * \ingroup     eventconfidentiality
 * \brief       Class of the dictionary Tag
 */

dol_include_once('/advancedictionaries/class/dictionary.class.php');

/**
 * Class for EventConfidentialityTagDictionary
 */
class EventConfidentialityTagDictionary extends Dictionary
{
    /**
