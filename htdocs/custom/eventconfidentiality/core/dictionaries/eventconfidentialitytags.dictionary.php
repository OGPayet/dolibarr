...
/**
 * \file        core/dictionaries/eventconfidentialitytags.dictionary.php
 * \ingroup     eventconfidentiality
 * \brief       Class of the dictionary tags
 */

dol_include_once('/advancedictionaries/class/dictionary.class.php');

/**
 * Class for eventconfidentialitytagsDictionary
 */
class eventconfidentialitytagsDictionary extends Dictionary
{
    /**
     ...
     */
    public $nameLabel = 'EventConfidentialityTagDictionaryLabel';

    /**
     * @var string      Name of the dictionary table without prefix (ex: c_country)
     */
    public $table_name = 'c_eventconfidentiality_tag';
