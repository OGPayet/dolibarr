...
/**
 * \file        core/dictionaries/requestmanagerurgency.dictionary.php
...
/**
 * Class for RequestManagerUrgencyDictionary
 */
class RequestManagerUrgencyDictionary extends Dictionary
{
     ...
     */
    public $nameLabel = 'RequestManagerUrgencyDictionaryLabel';

    /**
     * @var string      Name of the dictionary table without prefix (ex: c_country)
     */
    public $table_name = 'c_requestmanager_urgency';
