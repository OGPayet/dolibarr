...
/**
 * \file        core/dictionaries/requestmanagercategory.dictionary.php
...
/**
 * Class for RequestManagerCategoryDictionary
 */
class RequestManagerCategoryDictionary extends Dictionary
{
    /**
     ...
     */
    public $nameLabel = 'RequestManagerCategoryDictionaryLabel';

    /**
     * @var string      Name of the dictionary table without prefix (ex: c_country)
     */
    public $table_name = 'c_requestmanager_category';
