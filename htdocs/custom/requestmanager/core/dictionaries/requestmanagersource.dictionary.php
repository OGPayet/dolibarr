...
/**
 * \file        core/dictionaries/requestmanagersource.dictionary.php
...
/**
 * Class for RequestManagerSourceDictionary
 */
class RequestManagerSourceDictionary extends Dictionary
{
     ...
     */
    public $nameLabel = 'RequestManagerSourceDictionaryLabel';

    /**
     * @var string      Name of the dictionary table without prefix (ex: c_country)
     */
    public $table_name = 'c_requestmanager_source';
