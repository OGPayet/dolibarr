...
/**
 * \file        core/dictionaries/requestmanagerpriority.dictionary.php
...
/**
 * Class for RequestManagerPriorityDictionary
 */
class RequestManagerPriorityDictionary extends Dictionary
{
    /**
     ...
     */
    public $nameLabel = 'RequestManagerPriorityDictionaryLabel';

    /**
     * @var string      Name of the dictionary table without prefix (ex: c_country)
     */
    public $table_name = 'c_requestmanager_priority';
