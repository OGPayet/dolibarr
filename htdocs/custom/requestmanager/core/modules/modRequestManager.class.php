...
/**
 * 	\defgroup   requestmanager     Module Request Manager
 *  \brief      Example of a module descriptor.
 *				Such a file must be copied into htdocs/requestmanager/core/modules directory.
 *  \file       htdocs/requestmanager/core/modules/modRequestManager.class.php
 *  \ingroup    requestmanager
 *  \brief      Description and activation file for module Request Manager
 */
include_once DOL_DOCUMENT_ROOT . '/core/modules/DolibarrModules.class.php';
dol_include_once('/requestmanager/class/requestmanager.class.php');

/**
 *  Description and activation class for module Request Manager
 */
class modRequestManager extends DolibarrModules
{
	/**
	...
	public function __construct($db)
    {
        ...
        $this->numero = 163018;        // TODO Go on page http://wiki.dolibarr.org/index.php/List_of_modules_id to reserve id number for your module
        // Key text used to identify module (for permissions, menus, etc...)
        $this->rights_class = 'requestmanager';
        ...
        $this->picto = 'opendsi@requestmanager';
        ...
        $this->dirs = array('/requestmanager');

        // Config pages. Put here list of php page, stored into mymodule/admin directory, to use to setup module.
        $this->config_page_url = array("setup.php@requestmanager");
        ...
        $this->langfiles = array("requestmanager@requestmanager", "opendsi@requestmanager");
        ...
        if (!isset($conf->requestmanager) || !isset($conf->requestmanager->enabled)) {
            $conf->requestmanager = new stdClass();
            $conf->requestmanager->enabled = 0;
        }
        ...
        */
        ...
        $this->rights[$r][0] = 163032;
        $this->rights[$r][1] = 'Consulter les demandes';
        $this->rights[$r][3] = 0;
        $this->rights[$r][4] = 'lire';
        $r++;

        $this->rights[$r][0] = 163033;
        $this->rights[$r][1] = 'Créer/modifier les demandes';
        $this->rights[$r][3] = 0;
        $this->rights[$r][4] = 'creer';
        $r++;

        $this->rights[$r][0] = 163034;
        $this->rights[$r][1] = 'Supprimer les demandes';
        $this->rights[$r][3] = 0;
        $this->rights[$r][4] = 'supprimer';
        $r++;

        $this->rights[$r][0] = 163035;
        $this->rights[$r][1] = 'Reouvrir les demandes cloturées';
        $this->rights[$r][3] = 0;
        $this->rights[$r][4] = 'cloturer';
        $r++;

        $this->rights[$r][0] = 163036;
        ...
        $this->menu[$r] = array(
            'fk_menu' => 'fk_mainmenu=requestmanager',
            'type' => 'left',
            'titre' => 'RequestManagerMenuLeftTitle',
            'leftmenu' => 'requestmanager',
            'url' => '/requestmanager/list.php?mylist=1',
            'langs' => 'requestmanager@requestmanager',
            'position' => 100,
            'enabled' => '$conf->requestmanager->enabled',
        ...
        $this->menu[$r] = array(
            'fk_menu' => 'fk_mainmenu=requestmanager,fk_leftmenu=requestmanager',
            'type' => 'left',
            'titre' => 'RequestManagerMenuLeftList',
            'leftmenu' => 'requestmanager_list',
            'url' => '/requestmanager/list.php',
            'langs' => 'requestmanager@requestmanager',
            'position' => 300,
            'enabled' => '$conf->requestmanager->enabled',
            'perms' => '$user->rights->requestmanager->lire',
        ...
        $this->menu[$r] = array(
            'fk_menu' => 'fk_mainmenu=requestmanager,fk_leftmenu=requestmanager_list',
            'type' => 'left',
            'titre' => 'RequestManagerMenuLeftListNotAssigned',
            'leftmenu' => 'requestmanager_list_not_assigned',
            'url' => '/requestmanager/list.php?notassigned=1',
            'langs' => 'requestmanager@requestmanager',
            'position' => 310,
            'enabled' => '$conf->requestmanager->enabled',
            'perms' => '$user->rights->requestmanager->lire',
        ...
        $this->menu[$r] = array(
            'fk_menu' => 'fk_mainmenu=requestmanager,fk_leftmenu=requestmanager_list',
            'type' => 'left',
            'titre' => 'RequestManagerMenuLeftListNotResolved',
            'leftmenu' => 'requestmanager_list_not_resolved',
            'url' => '/requestmanager/list.php?status_type=-2',
            'langs' => 'requestmanager@requestmanager',
            'position' => 320,
            'enabled' => '$conf->requestmanager->enabled',
            'perms' => '$user->rights->requestmanager->lire',
        ...
        $this->menu[$r] = array(
            'fk_menu' => 'fk_mainmenu=requestmanager,fk_leftmenu=requestmanager_list',
            'type' => 'left',
            'titre' => 'RequestManagerMenuLeftListClosed',
            'leftmenu' => 'requestmanager_list_closed',
            'url' => '/requestmanager/list.php?status_type='.RequestManager::STATUS_TYPE_CLOSED,
            'langs' => 'requestmanager@requestmanager',
            'position' => 330,
            'enabled' => '$conf->requestmanager->enabled',
            'perms' => '$user->rights->requestmanager->lire',
        ...
        $this->menu[$r] = array(
            'fk_menu' => 'fk_mainmenu=requestmanager,fk_leftmenu=requestmanager',
            'type' => 'left',
            'titre' => 'RequestManagerMenuLeftMyList',
            'leftmenu' => 'requestmanager_mylist',
            'url' => '/requestmanager/list.php?mylist=1',
            'langs' => 'requestmanager@requestmanager',
            'position' => 400,
            'enabled' => '$conf->requestmanager->enabled',
        ...
        $this->menu[$r] = array(
            'fk_menu' => 'fk_mainmenu=requestmanager,fk_leftmenu=requestmanager_mylist',
            'type' => 'left',
            'titre' => 'RequestManagerMenuLeftListNotAssigned',
            'leftmenu' => 'requestmanager_mylist_not_assigned',
            'url' => '/requestmanager/list.php?mylist=1&notassigned=1',
            'langs' => 'requestmanager@requestmanager',
            'position' => 410,
            'enabled' => '$conf->requestmanager->enabled',
            'perms' => '$user->rights->requestmanager->lire',
        ...
        $this->menu[$r] = array(
            ...
            'type' => 'left',
            'titre' => 'RequestManagerMenuLeftListNotResolved',
            'leftmenu' => 'requestmanager_mylist_not_resolved',
            'url' => '/requestmanager/list.php?mylist=1&status_type=-2',
            'langs' => 'requestmanager@requestmanager',
            'position' => 420,
            'enabled' => '$conf->requestmanager->enabled',
            'perms' => '$user->rights->requestmanager->lire',
        ...
        $this->menu[$r] = array(
            ...
            'type' => 'left',
            'titre' => 'RequestManagerMenuLeftListClosed',
            'leftmenu' => 'requestmanager_mylist_closed',
            'url' => '/requestmanager/list.php?mylist=1&status_type='.RequestManager::STATUS_TYPE_CLOSED,
            'langs' => 'requestmanager@requestmanager',
            'position' => 430,
            'enabled' => '$conf->requestmanager->enabled',
            'perms' => '$user->rights->requestmanager->lire',
