	...
	static function getAvailableSubstitutesKeyFromRequest($db, $alsofornotify=0, $keyonly=1, &$requestmanager=null, $addgeneral=1)
    {
        ...
        if ($keyonly) {
            ...
            $vars = array(
                ...
                '__REQUEST_STATUS_NUM__'                => $requestmanager->new_statut > 0 ? $requestmanager->new_statut : $requestmanager->statut,
                '__REQUEST_STATUS_LABEL__'              => $requestmanager->new_statut > 0 ? $requestmanager->LibStatut($requestmanager->new_statut, 0) : $requestmanager->getLibStatut(0),
                '__REQUEST_STATUS_TYPE_NUM__'           => $requestmanager->new_statut_type > 0 ? $requestmanager->new_statut_type : $requestmanager->statut_type,
                '__REQUEST_STATUS_TYPE_LABEL__'         => $requestmanager->new_statut > 0 ? $requestmanager->LibStatut($requestmanager->new_statut, 12) : $requestmanager->getLibStatut(12),
            ...
            if ($alsofornotify) {
                ...
                $vars = array_merge($vars, array(
                    '__REQUEST_OLD_STATUS_NUM__'                    => $requestmanager->new_statut > 0 ? $requestmanager->statut : '',
                    '__REQUEST_OLD_STATUS_LABEL__'                  => $requestmanager->new_statut > 0 ? $requestmanager->getLibStatut(0) : '',
                    '__REQUEST_OLD_STATUS_TYPE_NUM__'               => $requestmanager->new_statut_type > 0 ? $requestmanager->statut_type : '',
                    '__REQUEST_OLD_STATUS_TYPE_LABEL__'             => $requestmanager->new_statut > 0 ? $requestmanager->getLibStatut(12) : '',
