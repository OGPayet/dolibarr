...
/**
 *	    \file       htdocs/requestmanager/admin/about.php
 *		\ingroup    requestmanager
 *		\brief      Page about of requestmanager module
 */
...
dol_fiche_head($head, 'changelog', $langs->trans("Module163018Name"), 0, 'opendsi@requestmanager');

$changelog = opendsi_common_getChangeLog('requestmanager');
