 ...
 */
class modRetourProduits extends DolibarrModules
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->langfiles = array("retourproduits@retourproduits");
        ...
        // Dictionaries
	    if (! isset($conf->retourproduits->enabled))
        {
		$conf->retourproduits=new stdClass();
		$conf->retourproduits->enabled=0;
        }
        ...
        */
		...
		$this->menu[$r]=array(	'fk_menu'=>'fk_mainmenu=products',
					...
					'target'=>'', 'user'=>2);
/*		$r++;
		$this->menu[$r]=array(	'fk_menu'=>'fk_mainmenu=products,fk_leftmenu=retourproduits',
					'type'=>'left',
					'titre'=>'NewReturnProducts',
					'mainmenu'=>'', 'leftmenu'=>'',
					'url'=>'/retourproduits/card.php?action=create&leftmenu=retourproduits',
					'langs'=>'retourproduits@retourproduits',
					'position'=>120, 'enabled'=>'1',
					'perms'=>'1',
					'target'=>'', 'user'=>2);*/
		...
		$this->menu[$r]=array(	'fk_menu'=>'fk_mainmenu=products,fk_leftmenu=retourproduits',
					'type'=>'left',
					'titre'=>'ListOfReturnProducts',
					'mainmenu'=>'', 'leftmenu'=>'',
					'url'=>'/retourproduits/list.php?leftmenu=retourproduits',
					'langs'=>'retourproduits@retourproduits',
					'position'=>120, 'enabled'=>'1',
					'perms'=>'1',
					'target'=>'', 'user'=>2);
