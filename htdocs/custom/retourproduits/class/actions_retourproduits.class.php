...
class ActionsRetourProduits // extends CommonObject
{
	...
	function formConfirm($parameters, $object, $action, $hookmanager) {
        ...
        if ($object->element == 'commande' && $action == 'returnproducts') {
            ...
            print $form->formconfirm($_SERVER["PHP_SELF"] . '?id=' . $object->id, dol_htmlcleanlastbr($langs->trans('CreateReturnProducts')), $langs->trans('SelectProductsToReturn'), 'create_return', $formquestion, 'yes', 1, 400, 700);
            return 1;
        }
