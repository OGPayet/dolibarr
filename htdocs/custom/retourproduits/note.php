...
$permissionnote=$user->rights->$module->creer;	// Used by the include of actions_setnotes.inc.php
...
if ($id > 0 || ! empty($ref))
{
	...
	dol_fiche_head($head, 'note', $langs->trans("RetourProduits"), -1, 'sending');

	$linkback = '<a href="'. dol_buildpath('custom/retourproduits/list.php', 1).'">'.$langs->trans("BackToList").'</a>';
