...
$page_name = $langs->trans("RetourProduitsSetup") ." - ". $langs->trans("Extrafields");
$tab = $langs->trans("RetourProduitsDet");

$help_url='EN:RetourProduit_Configuration|FR:Configuration_module_retourproduits|ES:ConfiguracionRetourProduits';
llxHeader('', $page_name);
...
dol_fiche_head($head, 'attributesevt', $tab, 0, 'retourproduits@retourproduits');
...
foreach ($extrafields->attribute_type as $key => $value) {
	...
	print '<td align="right"><a href="'.$_SERVER["PHP_SELF"].'?action=edit&attrname='.$key.'">';
	print img_edit().'</a>';
	print "&nbsp; <a href=\"".$_SERVER["PHP_SELF"]."?action=delete&attrname=$key\">";
...
if ($action != 'create' && $action != 'edit') {
	...
	print $langs->trans("NewAttribute")."</a>";
	print "</div>";
}
