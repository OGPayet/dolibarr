...
/**
 *	  \file	   htdocs/societe/admin/equipement_extrafields.php
 *		\ingroup	equipement
 *		\brief	  Page to setup extra fields of equipment
 */
...
$tab = $langs->trans("RetourProduits");
...
dol_fiche_head($head, 'attributes', $tab, 0, 'retourproduits@retourproduits');
