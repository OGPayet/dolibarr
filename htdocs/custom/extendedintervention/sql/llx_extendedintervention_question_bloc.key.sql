...
ALTER TABLE llx_extendedintervention_question_bloc ADD UNIQUE INDEX idx_ei_qb_unique (fk_fichinter, fk_c_question_bloc);
ALTER TABLE llx_extendedintervention_question_bloc ADD INDEX idx_ei_qb_fk_fichinter (fk_fichinter);
...
ALTER TABLE llx_extendedintervention_question_bloc ADD CONSTRAINT fk_ei_qb_fk_fichinter FOREIGN KEY (fk_fichinter) REFERENCES llx_fichinter (rowid); Trigger in bad location in v6 OK in v7+
