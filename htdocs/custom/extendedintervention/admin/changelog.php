...
/**
 *	    \file       htdocs/extendedintervention/admin/about.php
 *		\ingroup    extendedintervention
 *		\brief      Page about of extendedintervention module
 */
...
dol_fiche_head($head, 'changelog', $langs->trans("Module163023Name"), 0, 'opendsi@extendedintervention');

$changelog = opendsi_common_getChangeLog('extendedintervention');
