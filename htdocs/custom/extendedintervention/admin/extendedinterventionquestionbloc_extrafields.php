...
/**
 *      \file       htdocs/extendedintervention/admin/extendedinterventionquestionbloc_extrafields.php
...
$elementtype='extendedintervention_question_bloc'; //Must be the $table_element of the class that manage extrafield
...
$textobject=$langs->transnoentitiesnoconv("ExtendedInterventionQuestionBloc");
...
dol_fiche_head($head, 'extendedintervention_question_block_attributes', $langs->trans("Module163023Name"), 0, 'opendsi@extendedintervention');
