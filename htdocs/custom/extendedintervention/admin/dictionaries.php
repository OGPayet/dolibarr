...
/**
 *	    \file       htdocs/extendedintervention/admin/dictionaries.php
 *		\ingroup    extendedintervention
 *		\brief      Page dictionaries of extendedintervention module
 */
...
dol_include_once('/extendedintervention/lib/opendsi_common.lib.php');
...
dol_fiche_head($head, 'dictionaries', $langs->trans("Module163023Name"), 0, 'opendsi@extendedintervention');

$moduleFilter = ''; // array or string to set the dictionaries of witch modules to show in dictionaries list
$familyFilter = 'extendedintervention'; // array or string to set the dictionaries of witch family to show in dictionaries list
