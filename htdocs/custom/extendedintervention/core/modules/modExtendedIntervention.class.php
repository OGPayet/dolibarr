...
/**
 * 	\defgroup   extendedintervention     Module Extended Intervention
 *  \brief      Example of a module descriptor.
 *				Such a file must be copied into htdocs/extendedintervention/core/modules directory.
 *  \file       htdocs/extendedintervention/core/modules/modExtendedIntervention.class.php
 *  \ingroup    extendedintervention
 *  \brief      Description and activation file for module Extended Intervention
 */
include_once DOL_DOCUMENT_ROOT . '/core/modules/DolibarrModules.class.php';

/**
 *  Description and activation class for module Extended Intervention
 */
class modExtendedIntervention extends DolibarrModules
{
	/**
	...
	public function __construct($db)
    {
        ...
        $this->numero = 163023;        // TODO Go on page http://wiki.dolibarr.org/index.php/List_of_modules_id to reserve id number for your module
        // Key text used to identify module (for permissions, menus, etc...)
        $this->rights_class = 'extendedintervention';
        ...
        $this->description = "Description of module Extended Intervention";
        ...
        $this->picto = 'opendsi@extendedintervention';
        ...
        $this->module_parts = array(
            'dictionaries' => 1,
            'tpl' => 1,
            'hooks' => array('interventioncard', 'contractcard', 'requestmanagercard'),
            'triggers' => 1
        );
        ...
        $this->config_page_url = array("setup.php@extendedintervention");

        // Dependencies
        $this->hidden = false;            // A condition to hide module
        $this->depends = array('modFicheinter');        // List of modules id that must be enabled if this module is enabled
        $this->requiredby = array();    // List of modules id to disable if this one is disabled
        $this->conflictwith = array();    // List of modules id this module is in conflict with
        $this->phpmin = array(5, 0);                    // Minimum version of PHP required by module
        $this->need_dolibarr_version = array(4, 0);    // Minimum version of Dolibarr required by module
        $this->langfiles = array("extendedintervention@extendedintervention", "opendsi@extendedintervention");
        ...
        if (!isset($conf->extendedintervention) || !isset($conf->extendedintervention->enabled)) {
            $conf->extendedintervention = new stdClass();
            $conf->extendedintervention->enabled = 0;
        }
	...
	public function init($options='')
	{
        ...
        $this->_load_tables('/extendedintervention/sql/');

        // Create tables of all dictionaries
        dol_include_once('/advancedictionaries/class/dictionary.class.php');
        $dictionaries = Dictionary::fetchAllDictionaries($this->db, 'extendedintervention');
