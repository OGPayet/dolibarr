 ...
 */
class ExtendedInterventionQuestionBlocStatusDictionary extends Dictionary
{
    /**
     ...
     */
    public $nameLabel = 'ExtendedInterventionQuestionBlocStatusDictionaryLabel';

    /**
     * @var string      Name of the dictionary table without prefix (ex: c_country)
     */
    public $table_name = 'c_extendedintervention_status_qb';
    ...
    public $fields = array(
        ...
        'desactivate_bloc' => array(
            ...
            'label'      => 'ExtendedInterventionQuestionBlocStatusDictionaryDisableBloc',
            'type'       => 'boolean',
        ),
	...
	protected function initialize()
    {
        $this->fields['predefined_texts'] = array(
            ...
            'label' => 'ExtendedInterventionQuestionBlocStatusDictionaryPredefinedText',
            'type' => 'chkbxlst',
            'options' => 'c_extendedintervention_status_qbpt:code|predefined_text:rowid::active=1 and entity IN (' . getEntity('dictionary', 1) . ')',
            'label_separator' => ' - ',
            'td_output' => array(
