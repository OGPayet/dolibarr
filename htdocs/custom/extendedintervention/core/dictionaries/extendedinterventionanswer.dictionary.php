...
class ExtendedInterventionAnswerDictionary extends Dictionary
{
     ...
     */
    public $nameLabel = 'ExtendedInterventionAnswerDictionaryLabel';

    /**
     * @var string      Name of the dictionary table without prefix (ex: c_country)
     */
    public $table_name = 'c_extendedintervention_answer';
	...
	protected function initialize()
    {
        $this->fields['predefined_texts'] = array(
            ...
            'label' => 'ExtendedInterventionAnswerDictionaryPredefinedText',
            'type' => 'chkbxlst',
            'options' => 'c_extendedintervention_answer_pt:code|predefined_text:rowid::active=1 and entity IN (' . getEntity('dictionary', 1) . ')',
            'label_separator' => ' - ',
            'td_output' => array(
