...
/**
 * 	\defgroup   massupdaterights     Module MassUpdateRights
 *  \brief      Example of a module descriptor.
 *				Such a file must be copied into htdocs/massupdaterights/core/modules directory.
 *  \file       htdocs/massupdaterights/core/modules/modMassUpdateRights.class.php
 *  \ingroup    massupdaterights
 *  \brief      Description and activation file for module MassUpdateRights
 */
include_once DOL_DOCUMENT_ROOT .'/core/modules/DolibarrModules.class.php';


/**
 *  Description and activation class for module MassUpdateRights
 */
class modMassUpdateRights extends DolibarrModules
{
    /**
	...
	public function __construct($db)
	{
		...
		$this->numero = 163001;		// TODO Go on page http://wiki.dolibarr.org/index.php/List_of_modules_id to reserve id number for your module
		// Key text used to identify module (for permissions, menus, etc...)
		$this->rights_class = 'massupdaterights';
		...
		$this->description = "Description of module MassUpdateRights";
		...
		$this->picto='opendsi@massupdaterights';
        ...
        $this->config_page_url = array("setup.php@massupdaterights");
		...
		$this->langfiles = array("massupdaterights@massupdaterights", "opendsi@massupdaterights");
		...
		// );
        $this->const = array(
            0 => array('MASSUPDATERIGHTS_CSV_SEPARATOR_TO_USE','chaine',';',$langs->transnoentities('MASSUPDATERIGHTS_CSV_SEPARATOR_TO_USE'),1,'allentities'),
            1 => array('MASSUPDATERIGHTS_CSV_ENCLOSURE_TO_USE','chaine','"',$langs->transnoentities('MASSUPDATERIGHTS_CSV_ENCLOSURE_TO_USE'),1,'allentities'),
            2 => array('MASSUPDATERIGHTS_CSV_ESCAPE_TO_USE','chaine','\\',$langs->transnoentities('MASSUPDATERIGHTS_CSV_ESCAPE_TO_USE'),1,'allentities'),
        );
        ...
        */
        ...
        $this->menu[$r]=array(
            ...
            'type'=>'left',
            'titre'=>'MassUpdateRightsLeftMenu',
            'mainmenu'=>'home',
            'leftmenu'=>'massupdaterights',
            'url'=>'/custom/massupdaterights/index.php',
