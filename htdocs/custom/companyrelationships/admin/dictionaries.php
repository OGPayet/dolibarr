...
/**
 *	    \file       htdocs/companyrelationships/admin/dictionaries.php
 *		\ingroup    companyrelationships
 *		\brief      Page dictionaries of companyrelationships module
 */
...
dol_include_once('/companyrelationships/lib/opendsi_common.lib.php');
...
print load_fiche_titre($langs->trans("CompanyRelationshipsSetup"),$linkback,'title_setup');
print "<br>\n";


$head=companyrelationships_admin_prepare_head();

dol_fiche_head($head, 'dictionaries', $langs->trans("Module163020Name"), 0, 'opendsi@companyrelationships');

$moduleFilter = ''; // array or string to set the dictionaries of witch modules to show in dictionaries list
$familyFilter = 'companyrelationships'; // array or string to set the dictionaries of witch family to show in dictionaries list
