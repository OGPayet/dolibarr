...
/**
 * \file        core/dictionaries/companyrelationshipspublicspaceavailability.dictionary.php
 * \ingroup     companyrelationships
 * \brief       Class of the dictionary Public Space Availability
 */

dol_include_once('/advancedictionaries/class/dictionary.class.php');

/**
 * Class for CompanyRelationshipsPublicSpaceAvailabilityDictionary
 */
class CompanyRelationshipsPublicSpaceAvailabilityDictionary extends Dictionary
{
    /**
     ...
     */
    public $langs = array('companyrelationships@companyrelationships');
     ...
     */
    public $familyLabel = 'Module163020Name';
    ...
    public $fields = array(
        'element' => array(
            'name'       => 'element',
            'label'      => 'Element',
            'help'       => 'CompanyRelationshipsPublicSpaceAvailabilityDictionaryElementHelp',
            'type'       => 'varchar',
            'database'   => array(
              'length'   => 255,
            ),
