...
if ($resql) {
    ...
    while ($obj = $db->fetch_object($resql)) {
		...
		'#img\ssrc="/custom/equipement/img/object_equipement.png"#',
		'#a\shref="/custom/equipement/card.php#',
		'#img\ssrc="/theme/eldy/img/object_product.png"#',
		'#a\shref="/product/card.php#'
        );
        $descriptionReplacementArray = array(
		'img src="/synergies-tech/custom/equipement/img/object_equipement.png"',
		'a href="/synergies-tech/custom/equipement/card.php',
		'img src="/synergies-tech/theme/eldy/img/object_product.png"',
		'a href="/synergies-tech/product/card.php'
        );
