...
if ($search_contrat)		$sql .= " AND co.ref like '%".$db->escape($search_contrat)."%'";
if ($search_expedition)		$sql .= " AND exp.ref like '%".$db->escape($search_expedition)."%'";
if ($search_projet)			$sql .= " AND pro.ref like '%".$db->escape($search_projet)."%'";
...
if ($result) {
	...
	$urlparam="";
	print_barre_liste(
					$langs->trans("ListOfEquipEvents"), $page,
					"listEvent.php", $urlparam, $sortfield, $sortorder, '', $num
	);
