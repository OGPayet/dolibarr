...
if ($result) {
	...
	print_liste_field_titre(
					$langs->trans("Contrat"), $_SERVER["PHP_SELF"], "fi.ref", "",
					$urlparam, '', $sortfield, $sortorder
	);
	print_liste_field_titre(
	...
	print '</td><td class="liste_titre">';
	print '<input type="text" class="flat" name="search_company_client" value="'.$search_company_client.'" size="10">';
	print '</td><td class="liste_titre" colspan="1" align="right">';
	...
	print '<td class="liste_titre">';
	print '<input type="text" class="flat" name="search_reffichinter" value="'.$search_reffichinter.'" size="10"></td>';
	print '<td class="liste_titre">';
