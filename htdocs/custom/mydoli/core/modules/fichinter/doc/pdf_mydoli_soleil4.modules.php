 ...
 */
class pdf_mydoli_soleil4 extends ModelePDFFicheinter
{
	var $db;
	var $name;
	var $description;
...
*/
			...
			if ($conf->ficheinter->dir_output)
		{
			...
			{
				$pdf->SetXY(20,230);
				$pdf->Image($file, 30, 236, 0, 24);	// width=0 (auto)
			}
			...
			{
				$pdf->SetXY(110,230);
				$pdf->Image($file, 120, 236, 0, 24);	// width=0 (auto)
			}
		}
		}
	}
