 ...
 */
class pdf_mydoli_azur4 extends ModelePDFPropales
{
	var $db;
	var $name;
	var $description;
	...
	function _tableau_tot(&$pdf, $object, $deja_regle, $posy, $outputlangs)
	{
		...
		if ($conf->propal->dir_output)
		{
			...
			if (file_exists($file))
			{
				$pdf->Image($file, $this->page_largeur-89, $this->page_hauteur-49, 0, 28);	// width=0 (auto)
			}
		}
		$pdf->SetXY($this->page_largeur-90,$this->page_hauteur-50);
		$pdf->MultiCell(80, 30, "Bon pour accord", 1, 'L');
