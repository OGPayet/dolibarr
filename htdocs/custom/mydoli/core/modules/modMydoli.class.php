<?php
/* your Dolibarr in your pocket
 * Copyright (C) 2016  Veryphone
 *
...
/**
 * \defgroup    mydoli    myDoli module
 * \brief       myDoli module descriptor.
 *
 * Webservices for myDoli mobile application.
 */

/**
 * \file        htdocs/mydoli/core/modules/modMyDoli.class.php
 * \ingroup     mydoli
...
/**
 * Description and activation class for module myDoli
 */
class modMydoli extends DolibarrModules
{
...
//        )
	...
	public $description = "Module de communication pour l'application mobile myDoli";

	/** @var string Module long description */
	public $descriptionlong = "Module de communication pour l'application mobile myDoli";

	/**
	 * @var string Module editor name
	 * @since 4.0
	 */
	public $editor_name = "Veryphone";

	/**
	 * @var string Module editor website
	 * @since 4.0
	 */
	public $editor_url = "http://www.mydoli.fr";
...
// 		'workflow' => array(),
	...
	public $config_page_url = 'mydoli_about.php@mydoli';
	...
	public $phpmin = array(5, 0);

	/** @var int[] Minimum Dolibarr version required by this module */
	public $need_dolibarr_version = array(3, 4);

	/** @var string[] List of language files */
	public $langfiles = array('mydoli@mydoli');
...
// 	);
	...
	public function __construct($db)
	{
		...
		//	)
		//);
		$this->description=$langs->trans("myDoliDescription");
		$this->descriptionlong=$langs->trans("myDoliLongDescription");
		...
		// Dictionaries
		if (! isset($conf->mydoli->enabled)) {
			$conf->mydoli=new stdClass();
			$conf->mydoli->enabled = 0;
		}
