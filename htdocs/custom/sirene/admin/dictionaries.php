...
/**
 *	    \file       htdocs/sirene/admin/dictionaries.php
 *		\ingroup    sirene
 *		\brief      Page dictionaries of sirene module
 */
...
//
//dol_fiche_head($head, 'dictionaries', $langs->trans("Module163046Name"), 0, 'opendsi@sirene');
//
