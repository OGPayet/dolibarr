...
class modSirene extends DolibarrModules
{
	...
	public function __construct($db)
    {
        ...
        $this->depends = array('modSociete', 'modAdvanceDictionaries');        // List of modules id that must be enabled if this module is enabled
        ...
        // );
        $this->const = array(
            0 => array('CODENAF_CSV_SEPARATOR_TO_USE','chaine',';','',0,'allentities', 0),
            1 => array('CODENAF_CSV_ENCLOSURE_TO_USE','chaine','"','',0,'allentities', 0),
            2 => array('CODENAF_CSV_ESCAPE_TO_USE','chaine','\\','',0,'allentities', 0),
            3 => array('SIRENE_API_URL','chaine','https://api.insee.fr/entreprises/sirene/V3','',0,'allentities', 0),
            4 => array('SIRENE_VERIFICATION_SIRET_URL','chaine','https://annuaire-entreprises.data.gouv.fr/','',0,'allentities', 0),
            5 => array('SIRENE_MAIL_TO_SEND','chaine','','',0,'allentities', 0),
            6 => array('SIRENE_PROCESSING_TOKEN','chaine','','',0,'allentities', 0),
        );
        ...
        $this->dictionaries = array(
            'langs'=>'sirene@sirene',
            'tabname'=>array(MAIN_DB_PREFIX."c_codenaf"."c_sirene_country"),		                                                            // List of tables we want to see into dictonnary editor
            'tablib'=>array("SireneCodeNafDictionaryTable"),													                                    // Label of tables
            'tabsql'=>array('SELECT f.rowid as rowid, f.code, f.label, f.active FROM '.MAIN_DB_PREFIX.'c_codenaf as f LEFT JOIN '.MAIN_DB_PREFIX.' c.rowid, c.country_code, c.code_sirene FROM c_sirene_country as c ON f.rowid = c.rowid'),	// Request to select fields
            'tabsqlsort'=>array("code ASC"),																				// Sort order
            'tabfield'=>array("code,label, country_code, code_sirene"),																				// List of fields (result of select to show dictionary)
            ...
            'tabcond'=>array($conf->sirene->enabled)												                        // Condition to show each dictionary
        );
        /* Example:
        $this->dictionaries=array(
        ...
        */
        ...
        // Cronjobs
        $this->cronjobs = array(
            0 => array('label'=>$langs->trans("SireneCompanyStatus"), 'jobtype'=>'method', 'class'=>'/sirene/class/sirene.class.php', 'objectname'=>'Sirene', 'method'=>'cronSirene', 'parameters'=>'', 'comment'=>'', 'frequency'=>10, 'unitfrequency'=>60, 'test'=>true),
    ...
    public function init($options='')
    {
        ...
        $result = $extrafields->addExtraField('sirene_status', $langs->trans('SireneCompanyStatus'), 'boolean', 100 , '', 'societe', 0, 0, '', null, 0, '', 1, 0, '', '', 'sirene@sirene', '1');
        $result = $extrafields->addExtraField('sirene_update_date', $langs->trans("SireneCompanyUpdateDate"), 'datetime', 101, '', 'societe', 0, 0, '', null, 0, '', 1, 0, '', '', 'sirene@sirene', '1');
