...
/**
 * 	\defgroup	doctag	Doctag module
 * 	\brief		Doctag module descriptor.
 * 	\file		core/modules/modDoctag.class.php
 * 	\ingroup	doctag
 * 	\brief		Description and activation file for module Doctag
 */
include_once DOL_DOCUMENT_ROOT . "/core/modules/DolibarrModules.class.php";

/**
 * Description and activation class for module Doctag
 */
class modDoctag extends DolibarrModules
{
    ...
    public function __construct($db)
    {
        ...
        $this->numero = 104280; // 104000 to 104999 for ATM CONSULTING
        // Key text used to identify module (for permissions, menus, etc...)
        $this->rights_class = 'doctag';
        ...
        $this->picto = 'doctag@doctag'; // mypicto@doctag
        // Defined all module parts (triggers, login, substitutions, menus, css, etc...)
        // for default path (eg: /doctag/core/xxxxx) (0=disable, 1=enable)
        // for specific path of parts (eg: /doctag/core/modules/barcode)
        ...
        $this->module_parts = array(
            ...
            ,'hooks' => array('searchform','fileslib')
        ...
        // Example: this->dirs = array("/doctag/temp");
        $this->dirs = array();
        ...
        $this->langfiles = array("doctag@doctag"); // langfiles@doctag
        // Constants
        ...
        $this->tabs = array(
            ...
            //	'objecttype:+tabname1:Title1:langfile@doctag:$user->rights->doctag->read:/doctag/mynewtab1.php?id=__ID__',
            //	// To add another new tab identified by code tabname2
            //	'objecttype:+tabname2:Title2:langfile@doctag:$user->rights->othermodule->read:/doctag/mynewtab2.php?id=__ID__',
        ...
        // Dictionnaries
        if (! isset($conf->doctag->enabled)) {
            $conf->doctag=new stdClass();
            $conf->doctag->enabled = 0;
        }
        $this->dictionnaries = array();
        /* Example:
          // This is to avoid warnings
          if (! isset($conf->doctag->enabled)) $conf->doctag->enabled=0;
          $this->dictionnaries=array(
          'langs'=>'doctag@doctag',
        ...
        //	'type'=>'top',
        //	'titre'=>'Doctag top menu',
        //	'mainmenu'=>'doctag',
        //	'leftmenu'=>'doctag',
        //	'url'=>'/doctag/pagetop.php',
        //	// Lang file to use (without .lang) by module.
        //	// File must be in langs/code_CODE/ directory.
        //	'langs'=>'mylangfile',
        //	'position'=>100,
        //	// Define condition to show or hide menu entry.
        //	// Use '$conf->doctag->enabled' if entry must be visible if module is enabled.
        //	'enabled'=>'$conf->doctag->enabled',
        //	// Use 'perms'=>'$user->rights->doctag->level1->level2'
        ...
        //	'type'=>'left',
        //	'titre'=>'Doctag left menu',
        //	'mainmenu'=>'doctag',
        //	'leftmenu'=>'doctag',
        //	'url'=>'/doctag/pagelevel1.php',
        //	// Lang file to use (without .lang) by module.
        //	// File must be in langs/code_CODE/ directory.
        //	'langs'=>'mylangfile',
        //	'position'=>100,
     ...
     * and create data commands must be stored in directory /doctag/sql/
    ...
    {
        return $this->_load_tables('/doctag/sql/');
    }
}
