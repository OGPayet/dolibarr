...
<tr <?php echo 'id="row-'.$line->id.'" '.$bcdd[$var]; ?>>
	...
	<td align="right" class="linecoluht nowrap"><?php $coldisplay++; ?><?php if ($user->rights->synergiestech->product_line_price->lire) echo price($line->subprice); ?></td>

	<?php if (!empty($conf->multicurrency->enabled)) { ?>
	<td align="right" class="linecoluht_currency nowrap"><?php $coldisplay++; ?><?php if ($user->rights->synergiestech->product_line_price->lire) echo price($line->multicurrency_subprice); ?></td>
	<?php } ?>

	<?php if ($inputalsopricewithtax) { ?>
	<td align="right" class="linecoluttc nowrap"><?php $coldisplay++; ?><?php if ($user->rights->synergiestech->product_line_price->lire) echo (isset($line->pu_ttc)?price($line->pu_ttc):price($line->subprice)); ?></td>
	<?php } ?>
	...
	<?php if (!empty($line->remise_percent) && $line->special_code != 3 && $user->rights->synergiestech->product_line_discount->lire) { ?>
	...
	<?php } else { ?>
	<td align="right" class="liencolht nowrap"><?php $coldisplay++; ?><?php if ($user->rights->synergiestech->product_line_price->lire) echo price($line->total_ht); ?></td>
		<?php if (!empty($conf->multicurrency->enabled)) { ?>
		<td align="right" class="linecolutotalht_currency nowrap"><?php $coldisplay++; ?><?php if ($user->rights->synergiestech->product_line_price->lire) echo price($line->multicurrency_total_ht); ?></td>
		<?php } ?>
	<?php } ?>
        <?php if ($outputalsopricetotalwithtax) { ?>
        <td align="right" class="liencolht nowrap"><?php $coldisplay++; ?><?php if ($user->rights->synergiestech->product_line_price->lire) echo price($line->total_ttc); ?></td>
        <?php } ?>
