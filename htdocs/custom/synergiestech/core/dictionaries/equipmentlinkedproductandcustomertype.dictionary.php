 ...
 */
class EquipmentLinkedProductAndCustomerTypeDictionary extends Dictionary
{
    /**
     ...
     */
    public $nameLabel = 'SynergiesTechEquipementLinkedProductAndCustomerType';

    /**
     * @var string      Name of the dictionary table without prefix (ex: c_country)
     */
    public $table_name = 'c_synergiestech_eqproductcusttype';
    ...
    public $fields = array(
        'fk_product' => array(
            'name'       => 'fk_product',
            'label'      => 'SynergiesTechEquipementProductCustomerTypeProductLabel',
            'type'       => 'chkbxlst',
            'database'   => array(),
            'is_require' => true,
			'options' => 'product:label:rowid::'
        ),
        'customer_type' => array(
            'name'       => 'customer_type',
            'label'      => 'SynergiesTechEquipementProductCustomerTypeLabel',
            'type'       => 'sellist',
            'database'   => array(),
            'is_require' => true,
			'options' => 'c_ipbxcustomerauthentication_customertype:label:rowid::active=1'
        )
    );
