...
/**
 *	    \file       htdocs/synergiestech/admin/about.php
 *		\ingroup    synergiestech
 *		\brief      Page about of synergiestech module
 */
...
dol_fiche_head($head, 'changelog', $langs->trans("Module500100Name"), 0, 'action');

$changelog = opendsi_common_getChangeLog('synergiestech');
