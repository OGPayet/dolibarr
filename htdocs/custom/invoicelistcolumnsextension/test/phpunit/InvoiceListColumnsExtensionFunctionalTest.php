...
/**
 * \file    test/phpunit/InvoiceListColumnsExtensionFunctionalTest.php
...
/**
 * Class InvoiceListColumnsExtensionFunctionalTest
 *
 ...
 *
 * @package Testinvoicelistcolumnsextension
 */
class InvoiceListColumnsExtensionFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modInvoiceListColumnsExtension')->click();
		} else {
			// Disable the module
			$this->byHref('modInvoiceListColumnsExtension')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/invoicelistcolumnsextension/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('invoicelistcolumnsextension/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/invoicelistcolumnsextension/admin/about.php');
		$this->authenticate();
		return $this->assertContains('invoicelistcolumnsextension/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('invoicelistcolumnsextensionwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modInvoiceListColumnsExtension_InvoiceListColumnsExtensionTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modInvoiceListColumnsExtension_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
