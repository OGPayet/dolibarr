...
/**
 * 	\defgroup   invoicelistcolumnsextension     Module InvoiceListColumnsExtension
 *  \brief      InvoiceListColumnsExtension module descriptor.
 *
 *  \file       htdocs/invoicelistcolumnsextension/core/modules/modInvoiceListColumnsExtension.class.php
 *  \ingroup    invoicelistcolumnsextension
 *  \brief      Description and activation file for module InvoiceListColumnsExtension
 */
include_once DOL_DOCUMENT_ROOT.'/core/modules/DolibarrModules.class.php';

/**
 *  Description and activation class for module InvoiceListColumnsExtension
 */
class modInvoiceListColumnsExtension extends DolibarrModules
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->rights_class = 'invoicelistcolumnsextension';
		...
		// Module label (no space allowed), used if translation string 'ModuleInvoiceListColumnsExtensionName' not found (InvoiceListColumnsExtension is name of module).
		$this->name = preg_replace('/^mod/i', '', get_class($this));

		// Module description, used if translation string 'ModuleInvoiceListColumnsExtensionDesc' not found (InvoiceListColumnsExtension is name of module).
		$this->description = "Provide additionnal columns on invoice list";
		// Used only if file README.md and README-LL.md not found.
		$this->descriptionlong = "Provide additionnal columns on invoice list";
		...
		// Key used in llx_const table to save module status enabled/disabled (where INVOICELISTCOLUMNSEXTENSION is value of property name of module in uppercase)
		...
		$this->module_parts = array(
			...
			'css' => array(
				//    '/invoicelistcolumnsextension/css/invoicelistcolumnsextension.css.php',
			),
			// Set this to relative path of js file if module must load a js on all pages
			'js' => array(
				//   '/invoicelistcolumnsextension/js/invoicelistcolumnsextension.js.php',
			),
		...
		// Example: this->dirs = array("/invoicelistcolumnsextension/temp","/invoicelistcolumnsextension/subdir");
		...
		$this->langfiles = array("invoicelistcolumnsextension@invoicelistcolumnsextension");
		...
		//$this->automatic_activation = array('FR'=>'InvoiceListColumnsExtensionWasAutomaticallyActivatedBecauseOfYourCountryChoice');
		//$this->always_enabled = true;								// If true, can't be disabled

		// Constants
		// List of particular constants to add when module is enabled (key, 'chaine', value, desc, visible, 'current' or 'allentities', deleteonunactive)
		// Example: $this->const=array(1 => array('INVOICELISTCOLUMNSEXTENSION_MYNEWCONST1', 'chaine', 'myvalue', 'This is a constant to add', 1),
		//                             2 => array('INVOICELISTCOLUMNSEXTENSION_MYNEWCONST2', 'chaine', 'myvalue', 'This is another constant to add', 0, 'current', 1)
		// );
		$this->const = array();
		...
		if (!isset($conf->invoicelistcolumnsextension) || !isset($conf->invoicelistcolumnsextension->enabled)) {
			$conf->invoicelistcolumnsextension = new stdClass();
			$conf->invoicelistcolumnsextension->enabled = 0;
		}

		// Array to add new pages in new tabs
		$this->tabs = array();
		// Example:
		// $this->tabs[] = array('data'=>'objecttype:+tabname1:Title1:mylangfile@invoicelistcolumnsextension:$user->rights->invoicelistcolumnsextension->read:/invoicelistcolumnsextension/mynewtab1.php?id=__ID__');  					// To add a new tab identified by code tabname1
		// $this->tabs[] = array('data'=>'objecttype:+tabname2:SUBSTITUTION_Title2:mylangfile@invoicelistcolumnsextension:$user->rights->othermodule->read:/invoicelistcolumnsextension/mynewtab2.php?id=__ID__',  	// To add another new tab identified by code tabname2. Label will be result of calling all substitution functions on 'Title2' key.
		...
		/* Example:
		$this->dictionaries=array(
			'langs'=>'invoicelistcolumnsextension@invoicelistcolumnsextension',
			...
			'tabcond'=>array($conf->invoicelistcolumnsextension->enabled, $conf->invoicelistcolumnsextension->enabled, $conf->invoicelistcolumnsextension->enabled)
		);
		*/

		// Boxes/Widgets
		// Add here list of php file(s) stored in invoicelistcolumnsextension/core/boxes that contains a class to show a widget.
		$this->boxes = array(
			//  0 => array(
			//      'file' => 'invoicelistcolumnsextensionwidget1.php@invoicelistcolumnsextension',
			//      'note' => 'Widget provided by InvoiceListColumnsExtension',
		...
		$this->cronjobs = array(
			...
			//      'label' => 'MyJob label',
			//      'jobtype' => 'method',
			//      'class' => '/invoicelistcolumnsextension/class/myobject.class.php',
			//      'objectname' => 'MyObject',
			...
			//      'unitfrequency' => 3600,
			//      'status' => 0,
			//      'test' => '$conf->invoicelistcolumnsextension->enabled',
			//      'priority' => 50,
			//  ),
		);
		// Example: $this->cronjobs=array(
		//    0=>array('label'=>'My label', 'jobtype'=>'method', 'class'=>'/dir/class/file.class.php', 'objectname'=>'MyClass', 'method'=>'myMethod', 'parameters'=>'param1, param2', 'comment'=>'Comment', 'frequency'=>2, 'unitfrequency'=>3600, 'status'=>0, 'test'=>'$conf->invoicelistcolumnsextension->enabled', 'priority'=>50),
		//    1=>array('label'=>'My label', 'jobtype'=>'command', 'command'=>'', 'parameters'=>'param1, param2', 'comment'=>'Comment', 'frequency'=>1, 'unitfrequency'=>3600*24, 'status'=>0, 'test'=>'$conf->invoicelistcolumnsextension->enabled', 'priority'=>50)
		// );
		...
		$this->export_icon[$r]='myobject@invoicelistcolumnsextension';
		// Define $this->export_fields_array, $this->export_TypeFields_array and $this->export_entities_array
		$keyforclass = 'MyObject'; $keyforclassfile='/invoicelistcolumnsextension/class/myobject.class.php'; $keyforelement='myobject@invoicelistcolumnsextension';
		include DOL_DOCUMENT_ROOT.'/core/commonfieldsinexport.inc.php';
		//$this->export_fields_array[$r]['t.fieldtoadd']='FieldToAdd'; $this->export_TypeFields_array[$r]['t.fieldtoadd']='Text';
		//unset($this->export_fields_array[$r]['t.fieldtoremove']);
		//$keyforclass = 'MyObjectLine'; $keyforclassfile='/invoicelistcolumnsextension/class/myobject.class.php'; $keyforelement='myobjectline@invoicelistcolumnsextension'; $keyforalias='tl';
		//include DOL_DOCUMENT_ROOT.'/core/commonfieldsinexport.inc.php';
		$keyforselect='myobject'; $keyforaliasextra='extra'; $keyforelement='myobject@invoicelistcolumnsextension';
		include DOL_DOCUMENT_ROOT.'/core/extrafieldsinexport.inc.php';
		//$keyforselect='myobjectline'; $keyforaliasextra='extraline'; $keyforelement='myobjectline@invoicelistcolumnsextension';
		//include DOL_DOCUMENT_ROOT.'/core/extrafieldsinexport.inc.php';
