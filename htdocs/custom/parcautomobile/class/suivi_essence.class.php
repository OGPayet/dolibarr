...
class suivi_essence extends Commonobject{
	...
	public $element='suivi_essence';
	public $table_element='suivi_essence';
	...
	public function update($id)
	{
		...
		$sql.= ", litre = ".($this->litre>0?$this->db->escape($this->litre):"null");
