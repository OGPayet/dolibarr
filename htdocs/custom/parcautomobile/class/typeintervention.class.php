...
class typeintervention extends Commonobject{ 

	public $errors = array();
	public $rowid;
	public $label;

	public $element='typeintervention';
	public $table_element='typeintervention';
	...
	public function select_with_filter($selected=0,$name='typeintervention',$showempty=1,$val="rowid",$opt="label",$id='',$attr=''){
