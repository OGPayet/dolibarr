...
$elementtype='suivi_essence'; //Must be the $table_element of the class that manage extrafield

require DOL_DOCUMENT_ROOT.'/core/actions_extrafields.inc.php';

$textobject = $langs->trans("suivi_essence");
...
dol_fiche_head(
    $head,
    'champsessanc',
    $langs->trans("Champs_suivi_essenc"),
    0,
