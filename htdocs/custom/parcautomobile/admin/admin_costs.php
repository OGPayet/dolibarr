...
$elementtype='costsvehicule'; //Must be the $table_element of the class that manage extrafield

require DOL_DOCUMENT_ROOT.'/core/actions_extrafields.inc.php';

$textobject = $langs->trans("costsvehicule");
