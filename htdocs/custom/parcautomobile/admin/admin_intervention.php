...
$form        = new Form($db);
$parc        = new interventions_parc($db);
...
$elementtype='interventions_parc'; //Must be the $table_element of the class that manage extrafield

require DOL_DOCUMENT_ROOT.'/core/actions_extrafields.inc.php';

$textobject = $langs->trans("interventions_parc");
...
dol_fiche_head(
    $head,
    'champsintervention',
    $langs->trans("Champs_intervention"),
    0,
