...
$html.='<div style="width:100% !important;">';
    $html.= '<div id="div_2">';
        ...
        $html.= '<table  class="border_1" width="100%">';
            ...
            $html.= '<tr>';
                $html.= '<td align="left">'.$langs->trans('prix_inter').'</td>';
                $html.= '<td >'.number_format($item->prix,2,","," ").' ('.$conf->currency.')</td>';
            $html.= '</tr>';
            $date= explode('-', $item->date);
            $date=$date[2].'/'.$date[1].'/'.$date[0];
            $html.= '<tr>';
                $html.= '<td align="left">'.$langs->trans('date').'</td>';
                $html.= '<td >'.$date.'</td>';
            $html.= '</tr>';
    ...
    $html.= '<div class="cnd" > <span><b> &nbsp;'.$langs->trans("notes").':</span> </b></div>';
    $html.= '<table  class="border_1" width="100%">';
        $html.= '<tbody>';
             $html.= '<tr>';
                $html.= '<td align="left">'.nl2br($item->notes).'</td>';
            $html.= '</tr>';
