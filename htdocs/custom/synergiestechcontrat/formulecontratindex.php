...
/**
 *	\file       htdocs/formulecontrat/template/formulecontratindex.php
 *	\ingroup    formulecontrat
 *	\brief      Home page of formulecontrat top menu
 */
...
if (! $user->rights->formulecontrat->read) accessforbidden();

$langs->load("formulecontrat@formulecontrat");
...
llxHeader("",$langs->trans("formuleContratArea"));

print load_fiche_titre($langs->trans("formuleContratArea"),'','formulecontrat.png@formulecontrat');

print '<div class="fichecenter"><div class="fichethirdleft">';


/* BEGIN MODULEBUILDER DRAFT MYOBJECT
// Draft formuleContrat
if (! empty($conf->formulecontrat->enabled) && $user->rights->formulecontrat->read)
{
	$langs->load("orders");
