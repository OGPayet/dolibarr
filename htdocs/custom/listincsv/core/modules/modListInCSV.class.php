 ...
 */
class modListInCSV extends DolibarrModules
{
	/**
	...
	function __construct($db)
	{
		...
		$this->config_page_url = array("listincsv_setup.php@listincsv");
		...
		$this->langfiles = array("listincsv@listincsv");
	...
	function init($options='')
	{
		...
		$result=$this->_load_tables('/listincsv/sql/');
