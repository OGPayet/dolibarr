...
dol_fiche_head($head, 'user_doc', "InfoExtranet", 0, 'infoextranet@infoextranet');

$Parsedown = new Parsedown();

$buffer = file_get_contents('./USER_DOC.md');

print load_fiche_titre('Documentation utilisateur','','title_setup');
