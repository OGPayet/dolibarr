...
/**
 *  \file       address_note.php
 *  \ingroup    infoextranet
 *  \brief      Car with notes on AddressExtra
 */
...
$hookmanager->initHooks(array('addressnote'));     // Note that conf->hooks_modules contains array
...
$help_url='';
llxHeader('',$langs->trans('Address'),$help_url);
...
if ($id > 0 || ! empty($ref))
{
	...
	dol_fiche_head($head, 'note', $langs->trans("Address"), -1, 'address@infoextranet');
