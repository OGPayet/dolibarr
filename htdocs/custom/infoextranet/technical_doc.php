...
dol_fiche_head($head, 'technical_doc', "InfoExtranet", 0, 'infoextranet@infoextranet');

$Parsedown = new Parsedown();

$buffer = file_get_contents('./TECHNICAL_DOC.md');

print load_fiche_titre('Documentation technique','','title_setup');
