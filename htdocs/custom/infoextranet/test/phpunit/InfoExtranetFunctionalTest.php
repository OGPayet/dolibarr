...
/**
 * \file    test/functional/InfoExtranetFunctionalTest.php
...
/**
 * Class InfoExtranetFunctionalTest
 *
 ...
 *
 * @package Testinfoextranet
 */
class InfoExtranetFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
...
//        )
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modInfoExtranet')->click();
		} else {
			// Disable the module
			$this->byHref('modInfoExtranet')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/infoextranet/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('infoextranet/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/infoextranet/admin/about.php');
		$this->authenticate();
		return $this->assertContains('infoextranet/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('infoextranetwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modInfoExtranet_InfoExtranetTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modInfoExtranet_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
