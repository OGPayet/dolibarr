...
$hookmanager->initHooks(array('rolenote'));     // Note that conf->hooks_modules contains array
...
$help_url='';
llxHeader('',$langs->trans('Role'),$help_url);
...
if ($id > 0 || ! empty($ref))
{
	...
	dol_fiche_head($head, 'note', $langs->trans("Role"), -1, 'role@infoextranet');
