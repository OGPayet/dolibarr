...
/**
 *  \file       application_note.php
 *  \ingroup    infoextranet
 *  \brief      Car with notes on Application
 */
...
$hookmanager->initHooks(array('applicationnote'));     // Note that conf->hooks_modules contains array
...
$help_url='';
llxHeader('',$langs->trans('Application'),$help_url);
...
if ($id > 0 || ! empty($ref))
{
	...
	dol_fiche_head($head, 'note', $langs->trans("Application"), -1, 'application@infoextranet');
