...
dol_include_once("/infoextranet/class/myobject.class.php");


/**
 * mailing_mailinglist_infoextranet
 */
class mailing_mailinglist_infoextranet_myobject extends MailingTargets
{
	// CHANGE THIS: Put here a name not already used
	var $name='mailinglist_infoextranet_myobject';
	...
	var $picto='infoextranet@infoextranet';
	var $db;
	...
	function __construct($db)
	{
		...
		{
			$this->enabled=in_array('infoextranet',$conf->modules)?1:0;
		}
	}
	...
	function url($id)
	{
		return '<a href="'.dol_buildpath('/infoextranet/myobject_card.php',1).'?id='.$id.'">'.img_object('',"generic").'</a>';
	}
	...
	function add_to_target($mailing_id,$filtersarray=array())
	{
		...
		if ($result)
		{
			...
			dol_syslog("mailinglist_infoextranet_myobject.modules.php: mailing ".$num." targets found");
