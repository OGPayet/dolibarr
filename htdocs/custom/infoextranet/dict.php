...
/**
 *	    \file       htdocs/custom/infoextranet/dict.php
 *		\ingroup    setup
...
require_once DOL_DOCUMENT_ROOT.'/custom/infoextranet/lib/infoextranet.lib.php';
...
$allowed=$user->rights->infoextranet->dict;
...
complete_dictionary_with_infoextranet($taborder,$tabname,$tablib,$tabsql,$tabsqlsort,$tabfield,$tabfieldvalue,$tabfieldinsert,$tabrowid,$tabcond,$tabhelp,$tabfieldcheck);
                    ...
                    else
			{
				if (in_array($obj->code, array('AC_OTH','AC_OTH_AUTO'))) print $langs->trans("AlwaysActive");
                    ...
                    if ($iserasable)
                    {
                        ...
                        if ($user->rights->infoextranet->dict) print '<a href="'.$url.'action=delete">'.img_delete().'</a>';
...
function complete_dictionary_with_infoextranet(&$taborder,&$tabname,&$tablib,&$tabsql,&$tabsqlsort,&$tabfield,&$tabfieldvalue,&$tabfieldinsert,&$tabrowid,&$tabcond,&$tabhelp,&$tabfieldcheck)
{
    global $db, $modules, $conf, $langs;

    // Search modules
    $dir = DOL_DOCUMENT_ROOT."/custom/infoextranet/core/modules/";
