...
//-------------------------------------------------------------------------------
// Modification - Open-DSI - Begin
$sql.= " p.rowid AS project_id, p.ref AS project_ref, p.title AS project_title, p.dateo AS project_dateo, p.datee AS project_datee,";
...
if ($resql)
{
    ...
    if (! empty($arrayfields['f.ref']['checked']))
    {
        ...
        //-------------------------------------------------------------------------------
        // Modification - Open-DSI - Begin
		print '<input type="text" class="flat" name="search_ref" value="'.dol_escape_htmltag($search_ref).'" size="8">';
        // Modification - Open-DSI - End
        //-------------------------------------------------------------------------------
		print '</td>';
    }
	...
	print '<td class="liste_titre">';
        //-------------------------------------------------------------------------------
        // Modification - Open-DSI - Begin
		print '<input type="text" class="flat" name="search_company" value="'.dol_escape_htmltag($search_company).'" size="10">';
        // Modification - Open-DSI - End
        //-------------------------------------------------------------------------------
		print '</td>';
    }
    //-------------------------------------------------------------------------------
    // Modification - Open-DSI - Begin
    if (! empty($arrayfields['f.fk_project']['checked']))
    {
	print '<td class="liste_titre">';
		print '<input type="text" class="flat" name="search_project" value="'.dol_escape_htmltag($search_project).'" size="10">';
		print '</td>';
    }
    if (! empty($arrayfields['f.fk_contrat']['checked']))
    {
	print '<td class="liste_titre">';
		print '<input type="text" class="flat" name="search_contract" value="'.dol_escape_htmltag($search_contract).'" size="10">';
		print '</td>';
    }
    // Modification - Open-DSI - End
    //-------------------------------------------------------------------------------
    if (! empty($arrayfields['f.description']['checked']))
    {
        ...
        //-------------------------------------------------------------------------------
        // Modification - Open-DSI - Begin
	print '<input type="text" class="flat" name="search_desc" value="'.dol_escape_htmltag($search_desc).'" size="12">';
        // Modification - Open-DSI - End
        //-------------------------------------------------------------------------------
		print '</td>';
    }
    ...
    if (! empty($arrayfields['f.fk_project']['checked']))   print_liste_field_titre($arrayfields['f.fk_project']['label'],$_SERVER["PHP_SELF"],"p.ref","",$param,'',$sortfield,$sortorder);
    if (! empty($arrayfields['f.fk_contrat']['checked']))   print_liste_field_titre($arrayfields['f.fk_contrat']['label'],$_SERVER["PHP_SELF"],"c.ref","",$param,'',$sortfield,$sortorder);
	...
	while ($i < min($num, $limit))
	{
        ...
        if (! empty($arrayfields['f.fk_project']['checked']))
		{
			...
			if ($obj->project_id > 0) {
                ...
                $projectstatic->dateo = $obj->project_dateo;
                $projectstatic->datec = $obj->project_datee;
