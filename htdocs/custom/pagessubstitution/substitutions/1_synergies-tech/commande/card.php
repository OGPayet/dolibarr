		...
		if ($action != 'presend' && $action != 'editline') {
			...
			if (empty($reshook)) {
				...
				if ($object->statut > Commande::STATUS_DRAFT && ! $object->billed) {
					...
					if ($user->rights->commande->creer && $user->rights->commande->classify_billed && $object->statut >= Commande::STATUS_VALIDATED && empty($conf->global->WORKFLOW_DISABLE_CLASSIFY_BILLED_FROM_ORDER) && empty($conf->global->WORKFLOW_BILL_ON_SHIPMENT)) {
