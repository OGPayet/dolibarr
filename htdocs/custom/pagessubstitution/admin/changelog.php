...
/**
 *	    \file       htdocs/pagessubstitution/admin/about.php
 *		\ingroup    pagessubstitution
 *		\brief      Page about of pagessubstitution module
 */
...
dol_include_once('/pagessubstitution/lib/opendsi_common.lib.php');
...
$changelog = opendsi_common_getChangeLog('pagessubstitution');
