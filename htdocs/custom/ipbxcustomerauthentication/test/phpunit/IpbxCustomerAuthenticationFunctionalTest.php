...
/**
 * \file    test/phpunit/IpbxCustomerAuthenticationFunctionalTest.php
...
/**
 * Class IpbxCustomerAuthenticationFunctionalTest
 *
 ...
 *
 * @package Testipbxcustomerauthentication
 */
class IpbxCustomerAuthenticationFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modIpbxCustomerAuthentication')->click();
		} else {
			// Disable the module
			$this->byHref('modIpbxCustomerAuthentication')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/ipbxcustomerauthentication/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('ipbxcustomerauthentication/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/ipbxcustomerauthentication/admin/about.php');
		$this->authenticate();
		return $this->assertContains('ipbxcustomerauthentication/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('ipbxcustomerauthenticationwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modIpbxCustomerAuthentication_IpbxCustomerAuthenticationTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modIpbxCustomerAuthentication_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
