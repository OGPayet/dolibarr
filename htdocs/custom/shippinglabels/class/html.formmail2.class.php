...
/**
 *       \file       htdocs/core/class/html.FormMail2.class.php
 *       \ingroup    core
 ...
 *      Usage: $formail = new FormMail2($db)
 *             $FormMail2->proprietes=1 ou chaine ou tableau de valeurs
 *             $FormMail2->show_form() affiche le formulaire
 */
class FormMail2
{
    var $db;
    ...
    function get_form($addfileaction='addfile',$removefileaction='removefile')
    {
        ...
        $hookmanager->initHooks(array('FormMail2'));

        $parameters=array(
			'addfileaction' => $addfileaction,
			'removefileaction'=> $removefileaction
        );
        $reshook=$hookmanager->executeHooks('getFormMail2', $parameters, $this);
		...
		if (! empty($this->withto) || is_array($this->withto))
		{
			...
			else
			{
				...
				if (! empty($this->withto) && is_array($this->withto))
				{
					...
					$out.='contact@tiaris.eu, bug@tiaris.info';
