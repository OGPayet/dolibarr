...
function dol_get_fiche_head($links=array(), $active='0', $title='', $notab=0, $picto='', $pictoisfullpath=0)
{
	...
	$limittoshow=($conf->global->MAXTABS_IN_CARD?$conf->global->MAXTABS_IN_CARD -1 :99);
	...
	if ($displaytab > $limittoshow)
	{
		...
		$out.='<a href="" data-role="button" style="background-color: #F0F0F0;" class="tab inline-block">Plus <span class="badge">'.$nbintab.'</span></a>';
		$out.='<div id="moretabsList'.$tabsname.'" style="position: absolute; left: -999em;text-align: left;margin:0px;padding:2px">'.$outmore.'</div></div>';
		$out.="</div>\n";
