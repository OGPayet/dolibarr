 ...
 */
class InterfaceDigitalSignatureManagerTriggers extends DolibarrTriggers
{
	/**
	...
	{
		if (empty($conf->digitalsignaturemanager->enabled)) return 0; // If module is not enabled, we do nothing
