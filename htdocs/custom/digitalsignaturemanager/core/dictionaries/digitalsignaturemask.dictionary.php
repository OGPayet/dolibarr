 ...
 */
class DigitalSignatureMaskDictionary extends Dictionary
{

	/**
	 * @var string Linked document free type selected value
	 */
	const FREE_DOCUMENT_SELECTED = 'freeDocument';
    ...
    public $fields = array(
		...
		'availableOnlyForMasks' => array(
			...
			'type' => 'checkbox',
			'options'=> array(
				self::FREE_DOCUMENT_SELECTED => 'uploadedDocument'
			)
		)
    );
