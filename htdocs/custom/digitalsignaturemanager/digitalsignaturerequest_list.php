...
/**
 *   	\file       digitalsignaturerequest_list.php
 *		\ingroup    digitalsignaturemanager
 *		\brief      List page for digitalsignaturerequest
 */
...
// load digitalsignaturemanager libraries
require_once __DIR__.'/class/digitalsignaturerequest.class.php';
...
$contextpage = GETPOST('contextpage', 'aZ') ? GETPOST('contextpage', 'aZ') : 'digitalsignaturerequestlist'; // To manage different context of search
...
$hookmanager->initHooks(array('digitalsignaturerequestlist')); // Note that conf->hooks_modules contains array
...
if (empty($reshook))
{
	...
	// Mass actions
	$objectclass = 'DigitalSignatureRequest';
	$objectlabel = 'DigitalSignatureRequest';
	$uploaddir = $conf->digitalsignaturemanager->dir_output;
...
if ($num == 1 && !empty($conf->global->MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE) && $search_all && !$page)
{
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/digitalsignaturemanager/digitalsignaturerequest_card.php', 1).'?id='.$id);
	exit;
}
...
$newcardbutton = dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/digitalsignaturemanager/digitalsignaturerequest_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, 'object_'.$object->picto, 0, $newcardbutton, '', $limit, 0, 0, 1);

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendDigitalSignatureRequestRef";
$modelmail = "digitalsignaturerequest";
$objecttmp = new DigitalSignatureRequest($db);
...
if (in_array('builddoc', $arrayofmassactions) && ($nbtotalofrecords === '' || $nbtotalofrecords))
{
	...
	print $formfile->showdocuments('massfilesarea_digitalsignaturemanager', '', $filedir, $urlsource, 0, $delallowed, '', 1, 1, 0, 48, 1, $param, $title, '', '', '', null, $hidegeneratedfilelistifempty);
}
