...
dol_include_once('/digitalsignaturemanager/lib/digitalsignaturemanager.lib.php');
...
$module      = 'digitalsignaturemanager';
...
dol_fiche_head($head, 'dictionary_' . $name, '', -1, "digitalsignaturemanager@digitalsignaturemanager");

$moduleFilter = ''; // array or string to set the dictionaries of witch modules to show in dictionaries list
$familyFilter = 'digitalsignaturemanager'; // array or string to set the dictionaries of witch family to show in dictionaries list
