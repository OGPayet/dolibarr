...
/**
 * \file    test/phpunit/DigitalSignatureManagerFunctionalTest.php
...
/**
 * Class DigitalSignatureManagerFunctionalTest
 *
 ...
 *
 * @package Testdigitalsignaturemanager
 */
class DigitalSignatureManagerFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modDigitalSignatureManager')->click();
		} else {
			// Disable the module
			$this->byHref('modDigitalSignatureManager')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/digitalsignaturemanager/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('digitalsignaturemanager/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/digitalsignaturemanager/admin/about.php');
		$this->authenticate();
		return $this->assertContains('digitalsignaturemanager/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('digitalsignaturemanagerwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modDigitalSignatureManager_DigitalSignatureManagerTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modDigitalSignatureManager_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
