...
/**
 * \file    test/phpunit/InvoiceBetterStatusFunctionalTest.php
...
/**
 * Class InvoiceBetterStatusFunctionalTest
 *
 ...
 *
 * @package Testinvoicebetterstatus
 */
class InvoiceBetterStatusFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modInvoiceBetterStatus')->click();
		} else {
			// Disable the module
			$this->byHref('modInvoiceBetterStatus')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/invoicebetterstatus/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('invoicebetterstatus/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/invoicebetterstatus/admin/about.php');
		$this->authenticate();
		return $this->assertContains('invoicebetterstatus/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('invoicebetterstatuswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modInvoiceBetterStatus_InvoiceBetterStatusTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modInvoiceBetterStatus_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
