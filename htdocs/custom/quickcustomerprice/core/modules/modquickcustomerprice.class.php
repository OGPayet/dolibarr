 ...
 */
class modquickcustomerprice extends DolibarrModules
{
	/**
	...
	function __construct($db)
	{
		...
		$this->numero = 104874; // 104000 to 104999 for ATM CONSULTING
		// Key text used to identify module (for permissions, menus, etc...)
		$this->rights_class = 'quickcustomerprice';
		...
		$this->picto='quickcustomerprice@quickcustomerprice';

		// Defined all module parts (triggers, login, substitutions, menus, css, etc...)
		// for default path (eg: /quickcustomerprice/core/xxxxx) (0=disable, 1=enable)
		// for specific path of parts (eg: /quickcustomerprice/core/modules/barcode)
		// for specific css file (eg: /quickcustomerprice/css/quickcustomerprice.css.php)
		...
		// Example: this->dirs = array("/quickcustomerprice/temp");
		$this->dirs = array();
        ...
        */
		...
		//							'titre'=>'quickcustomerprice top menu',
		//							'mainmenu'=>'quickcustomerprice',
		//							'leftmenu'=>'quickcustomerprice',
		...
		//							'titre'=>'quickcustomerprice left menu',
		//							'mainmenu'=>'xxx',
		//							'leftmenu'=>'quickcustomerprice',
