...
class modBuyPriceHistory extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->tabs = array();
		// Example:
		// $this->tabs[] = array('data'=>'objecttype:+tabname1:Title1:mylangfile@buypricehistory:$user->rights->buypricehistory->read:/buypricehistory/mynewtab1.php?id=__ID__');  					// To add a new tab identified by code tabname1
		// $this->tabs[] = array('data'=>'objecttype:+tabname2:SUBSTITUTION_Title2:mylangfile@buypricehistory:$user->rights->othermodule->read:/buypricehistory/mynewtab2.php?id=__ID__',  	// To add another new tab identified by code tabname2. Label will be result of calling all substitution functions on 'Title2' key.
		...
		/* Example:
		$this->dictionaries=array(
			'langs'=>'buypricehistory@buypricehistory',
			...
			'tabcond'=>array($conf->buypricehistory->enabled, $conf->buypricehistory->enabled, $conf->buypricehistory->enabled)
		);
		*/
		...
		$this->boxes = array(
			//  0 => array(
			//      'file' => 'buypricehistorywidget1.php@buypricehistory',
			//      'note' => 'Widget provided by BuyPriceHistory',
		...
		$this->cronjobs = array(
			...
			//      'label' => 'MyJob label',
			//      'jobtype' => 'method',
			//      'class' => '/buypricehistory/class/buypricehistory.class.php',
			//      'objectname' => 'BuyPriceHistory',
			...
			//      'unitfrequency' => 3600,
			//      'status' => 0,
			//      'test' => '$conf->buypricehistory->enabled',
			//      'priority' => 50,
			//  ),
		);
		// Example: $this->cronjobs=array(
		//    0=>array('label'=>'My label', 'jobtype'=>'method', 'class'=>'/dir/class/file.class.php', 'objectname'=>'MyClass', 'method'=>'myMethod', 'parameters'=>'param1, param2', 'comment'=>'Comment', 'frequency'=>2, 'unitfrequency'=>3600, 'status'=>0, 'test'=>'$conf->buypricehistory->enabled', 'priority'=>50),
		//    1=>array('label'=>'My label', 'jobtype'=>'command', 'command'=>'', 'parameters'=>'param1, param2', 'comment'=>'Comment', 'frequency'=>1, 'unitfrequency'=>3600*24, 'status'=>0, 'test'=>'$conf->buypricehistory->enabled', 'priority'=>50)
		// );
