...
/**
 * \file    test/phpunit/BuyPriceHistoryFunctionalTest.php
...
/**
 * Class BuyPriceHistoryFunctionalTest
 *
 ...
 *
 * @package Testbuypricehistory
 */
class BuyPriceHistoryFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modBuyPriceHistory')->click();
		} else {
			// Disable the module
			$this->byHref('modBuyPriceHistory')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/buypricehistory/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('buypricehistory/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/buypricehistory/admin/about.php');
		$this->authenticate();
		return $this->assertContains('buypricehistory/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('buypricehistorywidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modBuyPriceHistory_BuyPriceHistoryTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modBuyPriceHistory_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
