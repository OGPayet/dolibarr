...
// Security check
if (empty($conf->buypricehistory->enabled)) accessforbidden('Module not enabled');
$socid = 0;
...
//$result = restrictedArea($user, 'buypricehistory', $id, '');
...
//$help_url="EN:Module_BuyPriceHistory|FR:Module_BuyPriceHistory_FR|ES:Módulo_BuyPriceHistory";
$help_url = '';
$title = $langs->trans('ListOf', $langs->transnoentitiesnoconv("BuyPriceHistorys"));
...
if ($num == 1 && !empty($conf->global->MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE) && $search_all && !$page)
{
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/buypricehistory/buypricehistory_card.php', 1).'?id='.$id);
	exit;
}
