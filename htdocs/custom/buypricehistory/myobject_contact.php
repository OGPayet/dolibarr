...
/**
 *  \file       buypricehistory/myobject_contact.php
...
dol_include_once('/buypricehistory/class/myobject.class.php');
dol_include_once('/buypricehistory/lib/buypricehistory_myobject.lib.php');

// Load translation files required by the page
$langs->loadLangs(array("buypricehistory@buypricehistory", "companies", "other", "mails"));
...
//$result = restrictedArea($user, 'buypricehistory', $object->id);

$permission = $user->rights->buypricehistory->myobject->write;
...
if ($object->id)
{
	...
	$linkback = '<a href="'.dol_buildpath('/buypricehistory/myobject_list.php', 1).'?restore_lastsearch_values=1'.(!empty($socid) ? '&socid='.$socid : '').'">'.$langs->trans("BackToList").'</a>';
