...
$hookmanager->initHooks(array('doliesignconfiglist'));     // Note that conf->hooks_modules contains array
...
$title = $langs->trans('ListOf', $langs->transnoentitiesnoconv("DoliEsignConfig"));
...
if ($num == 1 && ! empty($conf->global->MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE) && $search_all)
{
	...
	$id = $obj->rowid;
	header("Location: ".DOL_URL_ROOT.'/doliesign/config_card.php?id='.$id);
	exit;
}
...
$modelmail="config";
$objecttmp=new DoliEsignConfig($db);
...
if (in_array('builddoc',$arrayofmassactions) && ($nbtotalofrecords === '' || $nbtotalofrecords))
{
	if ($massaction == 'builddoc' || $action == 'remove_file' || $show_files)
	{
		...
		$genallowed=$user->rights->doliesign->read;
		$delallowed=$user->rights->doliesign->create;

		print $formfile->showdocuments('massfilesarea_doliesign','',$filedir,$urlsource,0,$delallowed,'',1,1,0,48,1,$param,$title,'');
	}
	else
	{
