...
/**
 * \file    doliesign/admin/about.php
 * \ingroup doliesign
 * \brief   About page of module DoliEsign.
 */
...
dol_fiche_head($head, 'about', '', 0, 'doliesign@doliesign');

dol_include_once('/doliesign/core/modules/modDoliEsign.class.php');
print '<div class="netlogic-bg">';
print '<img src="../img/logo-net-logic.png">';
$tmpmodule = new modDoliEsign($db);
if (DoliEsign::checkDolVersion('6.0')) {
	print $tmpmodule->getDescLong();
} else {
	print '<br>'.$langs->trans($tmpmodule->descriptionlong);
}
print '</div>';
// Page end
dol_fiche_end();
