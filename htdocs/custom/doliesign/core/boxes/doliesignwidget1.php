...
/**
 * \file    modulebuilder/template/core/boxes/doliesignwidget1.php
 * \ingroup doliesign
 * \brief   Widget provided by DoliEsign
 *
 ...
 */
class doliesignwidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "doliesignbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "doliesign@doliesign";
	 ...
	 */
	public $depends = array('doliesign');
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		//$this->hidden = ! ($user->rights->doliesign->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		//include_once DOL_DOCUMENT_ROOT . "/doliesign/class/doliesign.class.php";

		// Populate the head at runtime
		$text = $langs->trans("DoliEsignBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_doliesign@doliesign',
