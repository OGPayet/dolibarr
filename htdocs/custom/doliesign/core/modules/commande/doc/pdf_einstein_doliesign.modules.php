...
/**
 *	\file       htdocs/doliesign/core/modules/commande/doc/pdf_einstein_doliesign.modules.php
 *	\ingroup    commande
 ...
 */
class pdf_einstein_doliesign extends ModelePDFCommandes
{
    /**
	...
	function _signature_area(&$pdf, $object, $posy, $outputlangs)
	{
		...
		$pdf->SetFont('','', $default_font_size - 2);
		$pdf->MultiCell($largcol, $tab_hl, $outputlangs->transnoentities("NameAndSignatureOfExternalContact"), 0, 'L', 1);

		$hookmanager->initHooks(array('pdfgeneration'));
		$parameters=array('pdf'=>$pdf, 'outputlangs'=>$outputlangs, 'posy'=>$tab_top + $tab_hl,
			'tab'=>$tab_hl, 'posx'=>$posx, 'fontSize'=>$default_font_size, 'largcol'=>$largcol, 'sourceContact'=>'external');
		$reshook=$hookmanager->executeHooks('changeSignatureArea', $parameters, $object, $action);    // Note that $action and $object may have been modified by some hooks
