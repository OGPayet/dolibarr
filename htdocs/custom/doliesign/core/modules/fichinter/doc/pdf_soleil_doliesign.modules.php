...
/**
 *	\file       htdocs/doliesign/core/modules/fichinter/doc/pdf_soleil_doliesign.modules.php
 *	\ingroup    ficheinter
 ...
 */
class pdf_soleil_doliesign extends ModelePDFFicheinter
{
	var $db;
	var $name;
	var $description;
...
*/
		...
		if (empty($hidebottom))
		{
			...
			$hookmanager->initHooks(array('pdfgeneration'));
			$parameters=array('pdf'=>$pdf, 'outputlangs'=>$outputlangs, 'posy'=>228,
				'tab'=>7, 'posx'=>20, 'fontSize'=>$default_font_size, 'largcol'=>80, 'sourceContact'=>'internal');
			$reshook=$hookmanager->executeHooks('changeSignatureArea', $parameters, $object, $action);

			if ($reshook < 1) {
				$pdf->SetXY(20,235);
				$pdf->MultiCell(80,21, '', 1);
			}
