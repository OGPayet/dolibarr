...
/**
 *	\file       htdocs/doliesign/core/modules/propale/doc/pdf_azur_doliesign.modules.php
 *	\ingroup    propale
 ...
 */
class pdf_azur_doliesign extends ModelePDFPropales
{
	var $db;
	var $name;
	var $description;
