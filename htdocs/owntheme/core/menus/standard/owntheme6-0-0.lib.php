...
/**
 *  \file		htdocs/core/menus/standard/owntheme.lib.php
	...
	if (empty($noout))
	{
		...
		<script type="text/javascript">
			$(window).on('load',function(){
			    ...
			    // 	$("#inner-content-div").scrollTo(to_scroll);
			    // }else if(to_scroll2.length > 0){
			    // 	$("#inner-content-div").scrollTo(to_scroll2);
			    // }
			});
